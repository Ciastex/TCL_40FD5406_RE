...
var all_country 	= ["Austrālija","Austrija","Beļģija","Bulgārija","Horvātija","Čehija","Dānija","Somija","Francija","Vācija",
						...
						"Moldova"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albānija","Belarus","Iceland",
						"Lietuva","","","","","", "Bosnija un Hercegovina","Kipra","Kosova","Maķedonija",
						"Malta","Melnkalne","Others"];
...
var sysOptions		= ["E-rokasgrāmata","Izvēlnes valoda","Taimeris","Bloķēt","Ieejas iestatījumi",
						...
						"Papildu uzstādījumi","Atiestatīt veikal režīmu","LED indikators","Tūlītēja ieslēgšana","Auto shop mode","Area","Demonstrācijas režīms"];
...
var picOptions		= ["Attēla sākotnējā iestatīšana",
						...
						"Papildu uzstādījumi","Attēla atiestatīšana"];
...
var smartTVOptions		= ["Smart TV portāls","HbbTV","Koplietot un skatīties","WiFi displejs","Smart TV politika",
    "Tīkla gaidstāve","Atiestatīt smart TV"];
...
var eStickerTipWords = ["Atmiņa ir mazāk kā 500 MB. Vai izdzēst video Demonstrācijas režīmā, lai atbrīvotu vietu?"];
