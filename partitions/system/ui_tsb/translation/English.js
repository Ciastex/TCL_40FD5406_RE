...
var all_country 	= ["Australia","Austria","Belgium","Bulgaria","Croatia","Czech Republic","Denmark","Finland","France","Germany",
				  ...
				  /*5*/ "China","Taiwan","Brazil","Canada","Mexico","United States","South Korea","Others","Vietnam"/*新添加的，底层结构体中没有*/,"Ukraine"/*新添加的，底层结构体中没有*/,
						...
						"Angola","Congo","India","Turkmenistan","Colombia","Mongolia","Bangladesh","Nepal","Sri Lanka","Nouth Korea",
				 ...
				 /*10*/ "Armenia","Oman","yemen","Syria","Palestine","Afghanistan","Morocco","benin","IvoryCoast","Nigeria",
						...
						"Malta","Montenegro"," ","Singapore","Malaysia","NewCaledonia","Suriname","Jamaica","Curacao","Aruba",
						"Antigua & Barbuda","St Lucia","Barbados","St Vincent","St Kitts & Nevis","Grenada","Trinidad & Tobago","Guyana","Puerto Rico","Panama",
				 /*15*/ "Dominica","Cuba","Honduras","Haiti","Cambodia","others","Dominican Republic","Bonaire"," "," "];
...
var smartTVOptions		= ["Smart TV portal","HbbTV","Share&See","WiFi display","Smart TV policy",
                            "Networked standby","Reset smart TV"];
