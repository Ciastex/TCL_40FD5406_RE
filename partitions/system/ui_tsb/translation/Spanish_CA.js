var  all_country  = ["Australia","Austria","Belgium","Bulgaria","Croatia","Czech Republic","Denmark","Finland","Francia","Germany",
					...
					"Serbia","Slovenia","Spain","Sweden","Switzerland","United Kingdom","Nueva Zelanda"," "/*Arab*/,"Estonia"," "/*Hebrew*/,
					"Latvia","Slovakia","Turquía","Ireland","Japón","Filipinas","Tailandia","Maldivas","Uruguay","Peru",
					"Argentina","Chile","Venezuela","Ecuador","Costa Rica","Paraguay","Bolivia","Belize","Nicaragua","Guatemala",
					"China","Taiwan","Brazil","Canadá","Mexico","United States","South Korea","Otros","Vietnam"/*新添加的，底层结构体中没有*/,"Ucrania"/*新添加的，底层结构体中没有*/,
					"Irán","Iraq"," "," ","Uzbekistán"," ","Kirguistán","Argelia","Egipto","Túnez",
					"Tanzania","Kenia","Paquistán","Indonesia","Kuwait","Arabia Saudita","Catar","Israel","Líbano","Baréin",
					...
					"Armenia","Omán","Yemén","Siria","Palestina","Afganistán","Marruecos","Benín","IvoryCoast","Nigeria",
					"Sudán","Etiopía","Zambia"," ","Sudáfrica","Mozambique","Libia","Albania","Belarus","Iceland",
					"Lithuania","Mauricio","Dubai","UAE","Tayikistán","Bengal","Bosnia Hercegovina","Cyprus","Kosovo","Macedonia",
...
var chOptions = ["Exploración de canales","Lista de canales","EPG","Organizador de canales","Diagnóstico de canales","Cambio de hora","Subtítulo","Teletexto","Tipo de lista de canales","Servicio de datos"];	
...
var miracastRemind = ["La vantalla Inalámbrica te permite compartir la pantalla y sonido de un dispositivo, como tu teléfono o tableta, con tu TV, de forma inalámbrica (sin cables). Esto te permite ver en tu TV, al mismo tiempo, lo que tu teléfono o tableta muestran. Por ejemplo, puedes reproducir un vídeo en tu teléfono y verlo simultáneamente en tu TV, o puedes usar tu tableta como control para juegos y ver el contenido en la pantalla grande de tu TV.","La pantalla Inalámbrica en el TV está lista. Puedes comenzar a compartir la pantalla de tu dispositivo con tu TV ahora.","Conectando. ¡Por favor espera!","¡Conexión fallida!","Conexión fallida. Revisa la conexión."];	
...
var contentSpan3Array = ["Mira y disfruta tus apps favoritas mediante la página Smart TV.","Mira fotos, videos y escucha música desde un dispositivo USB.","Conecta tu TV y tu smartphone o tableta a la misma LAN.","Pulsa nScreen o TV a Distancia en tu smartphone o tableta.","Comparte fotos, videos y música en multipantallas con tu familia y opera tu TV desde tu smartphone.","Conecte su TV y su smartphone o tableta a la misma LAN."];
...
var noChannelListRemind = ["No se encontraron canales. Lista de canales disponible después de la búsqueda de canales.","Exploración de canales"];	
...
var sysCCOtionMode = ["Usuario","Por defecto"];
...
var sysCCOptionFontEdgeStyle = ["Por defecto","Ninguno","Elevado","Deprimido","Sombra izquierda","Sombra derecha"];
var sysCCOptionFontColor = ["Por defecto","Negro","Blanco","Rojo","Verde","Azul","Amarillo","Magenta","Cian"];	
var sysCCOptionFontOpacity = ["Por defecto","Sólido","Parpadeando","Translúcido","Transparente"];
...
var sportsModeInitReminds = ["Este asistente sirve para configurar la unidad USB para el Modo Deportes. Selecciona el modo de configuración.", "Selecciona el tamaño del archivo para el Modo Deportes.", "Creando archivo Modo Deportes", "¡La velocidad de la unidad USB es muy lenta (< %f MB/seg) para el Modo Deportes!", "La unidad USB está lista para el Modo Deportes. Te recomendamos cambiarla (a velocidad > %f MB/seg) para un mejor funcionamiento.", "La unidad USB está lista para el Modo Deportes."];	
var sportsModeExtra = ["¿Deseas detener el Modo Deportes y cambiar de canal?","¿Deseas detener el Modo Deportes y cambiar la fuente a dispositivo conectado a la entrada SCART?","¿Deseas detener el Modo Deportes y cambiar la fuente a dispositivo conectado a la entrada HDMI?","El Modo Deportes no es compatible con Canal Codificado.","¿Deseas detener el Modo Deportes y acceder a EPG?","¿Deseas detener el Modo Deportes y acceder a Multimedia?","¿Deseas detener el Modo Deportes y cambiar la fuente de entrada?","El TV cerrará el actual Modo Deportes. ¿Deseas concluir?"];	
