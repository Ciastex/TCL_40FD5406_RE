...
{name:sourceTitle[1],source:"AV",sourceInput:0,icon:"images/Icon-Sourse_AV.png",showFlag:0},
...
function switchSource()
{
    ...
    console.log("--hzm debug top.g_setting.location = " + top.g_setting.location + "  top.iseStickerPlaying = " + top.iseStickerPlaying);
    if(top.preTempPage=="media" || (top.g_setting.location != 0  && top.iseStickerPlaying == 1))
	{
		...
		else  if(top.iseStickerPlaying == 1)
		{
            top.stopeSticker();
		}
		else
	...
	switch(inputListEx[positionH].index)
	{
        ...
        case 8:
            if (1/*source != inputList[sourceMediaIndex].sourceInput*/) {
                ...
                {
                    top.$("operatePage").src = "";
                    top.$('operatePage').src = "password.html?usbLock";
