...
function setValuesForItems()
{
	...
	else
	{
		...
		{
            productInfoLiList[0].innerHTML = productInfoWords[0] + " : " + factoryInfo.swName+"."+top.configPackVersion;
		}
		if(channel.systemCountry == 134){//马来西亚认证要求固定版本号V8-N563T01-LF1V095
			productInfoLiList[0].innerHTML = productInfoWords[0] + " : " + "V8-N563T01-LF1V095";
		}
		if(top.isEUFlag)
		{
