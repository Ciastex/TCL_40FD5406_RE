...
/**
 * Hashes int keys. 'key' is a pointer to string.
 */
int hashmapStringHash(void* key);

/**
 * Compares two string keys for equality.
 */
bool hashmapStringEquals(void* keyA, void* keyB);
...
void* hashmapTestMalloc(int size);
void hashmapTestFree(void *ptr);
