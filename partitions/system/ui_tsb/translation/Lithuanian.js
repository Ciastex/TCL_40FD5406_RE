...
var all_country 	= ["Australija","Austrija","Belgija","Bulgarija","Kroatija","Čekija","Danija","Suomija","Prancūzija","Vokietija",
						...
						"Lietuva","","","","","","Bosnija ir Hercegovina","Kipras","Kosovas","Makedonija",
						"Malta","Juodkalnija","Others"];
...
var sysOptions		= ["El. vadovas","Meniu kalba","Laikmatis","Užrakinti","Įvesties nustatymai",
						...
						"Papildomi nustatymai","Atstatyti pard.","LED kontrolinė lemputė","Momentinis maitinimo įjung.","Auto shop mode","Area","Demonstracinis režimas"];
...
var picOptions		= ["Vaizdo išankstinė nuostata",
						...
						"Papildomi nustatymai","Vaizdo atkūrimas"];
...
var smartTVOptions		= ["Smart TV portalas","HbbTV","Dalinkitės ir žiūrėkite","„Wi-Fi“ ekranas","Smart TV politika",
    "Pristabdyta tinkle","Atkurkite smart TV veikimą"];
...
var eStickerTipWords = ["Atmintinėje – mažiau nei 500 MB. Ar norite panaikinti demonstracijos režimo vaizdo įrašus, kad atlaisvintumėte vietos?"];
