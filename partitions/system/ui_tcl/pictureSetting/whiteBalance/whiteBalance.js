...
function ttsRead()
{
	...
	if(focusType == "picWhiteBalList" && 3 == parent.currentShowMenu)
	{
		...
		{
			case 0:
				ttsName = top.picAdWhiteBal[0] + ",";
				currentStatus = picRgainVal;
				break;
			case 1:
				ttsName = top.picAdWhiteBal[1] + ",";
				currentStatus = picGgainVal;
				break;
			case 2:
				ttsName = top.picAdWhiteBal[2] + ",";
				currentStatus = picBgainVal;
				break;
			case 3:
				ttsName = top.picAdWhiteBal[3] + ",";
				currentStatus = picRoffsetVal;
				break;
			case 4:
				ttsName = top.picAdWhiteBal[4] + ",";
				currentStatus = picGoffsetVal;
				break;
			case 5:
				ttsName = top.picAdWhiteBal[5] + ",";
				currentStatus = picBoffsetVal;
				break;
			default:
				ttsName = "";
				currentStatus = "";
	...
	if("" != ttsStr)
	{
		...
		//top.ttsLog("focusType=" + focusType + " adjustUpOption=" + positionV);
