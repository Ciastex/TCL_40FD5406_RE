...
var all_country 	= ["Austrália","Áustria","Bélgica","Bulgária","Croácia","República Checa","Dinamarca","Finlândia","França","Alemanha",
						...
						"Irão","Iraque"," "," ","Uzbequistão"," ","Quirguistão","Argélia","Egito"," ",
						"Tanzânia","Quénia"," "," "," ","Arábia Saudita"," ","Israel"," "," ",
						" "," ","Índia"," "," "," "," "," ","Sri Lanka"," ",
						"Moldávia"," ","EI Salvador"," "," "," ","Jordânia"," "," "," ",
						" "," "," "," "," "," "," "," "," ","Nigéria",
						" "," ","Zâmbia"," "," "," "," ","Albânia","Belarus","Iceland",
						"Lituânia","","Dubai","EAU","Tajiquist?o","Bengala","Bósnia e Herzegovina","Chipre","Kosovo","Macedónia",
...
var all_language 	= ["Checo","*","Dinamarquês","*","*","Alemão","Inglês","Francês","Grego","Espanhol",
						...
						"Galês","Árabe","Írsky","Latvian","*","Turco","Estonian","Neerlandês"/*Netherlands*/,"Coreano","*",
...
var sysOptions		= ["E-Manual","Idioma OSD","Temporizador","Bloquear","Definições de entrada",
						...
						"Configurações avançadas","Reiniciar compra","Indicador LED","Ativação imediata","Auto shop mode","Area","Modo demonstração"];
...
var picOptions		= ["Modo de imagem",
						...
						"Configurações avançadas","Reinicializar imagem"];
...
var smartTVOptions		= ["Portal da Smart TV","HbbTV","Partilhar e Ver","Visualiz. Wifi","Política da Smart TV",
                            "Modo de espera em rede", "Reiniciar smart TV"];
...
var eStickerTipWords = ["Armazenamento inferior a 500M, pretende apagar os vídeos no modo Demo para obter mais espaço?"];
