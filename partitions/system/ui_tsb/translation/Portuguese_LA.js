var  all_country  = ["*","*","*","*","*","*","*","*","França","*","*","*","*","*","*","*","*","*","*","*","*","*","*","*","*","*","*"," "/*Arab*/,"*"," "/*Hebrew*/,"*","*","*","*","*","Filipinas","*","*","Uruguai","Peru","Argentina","Chile","Venezuela","Equador","Costa Rica","Paraguai","Bolívia","Belize","Nicarágua","Guatemala","*","*","Brasil","*","*","*","*","Outros","*"/*新添加的，底层结构体中没有*/,"*"/*新添加的，底层结构体中没有*/," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","El Salvador"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ",
"*","*","*","","","","","","*","*","*","*","*","*","Outros","","","","","Jamaica"];
...
var initialHotkeys = ["Retornar","Selecionar","Próximo."];	
...
var smartTVOptions = ["Portal Smart TV","HbbTV","Share&See","Wireless Display","Política de Smart TV",                            "Standby em rede","Reiniciar Smart TV"];
...
var eStickerTipWords = ["Memória disponível inferior a 500M. Você gostaria de remover o video de demostração para obter mais espaço?"];
...
var fortoshiba	= ["Versão do Netflix","Cabo/Antena","COMP"];
