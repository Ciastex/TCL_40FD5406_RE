...
var all_country 	= ["Ausztrália","Ausztria","Belgium","Bulgária","Horvátország","Cseh Köztársaság","Dánia","Finnország","Franciaország","Németország",
						...
						"Moldova"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albánia","Belarus","Iceland",
						"Litvánia","","","","","","Bosznia-Hercegovina","Ciprus","Koszovó","Macedónia",
						"Málta","Montenegró","Others"];
...
var sysOptions		= ["E-kézikönyv","OSD nyelv","Idő beállítása","Zárolás","Bemeneti beállítások",
						...
						"A speciális beállítások","Gyári alapbeállítás","LED jelzőfény","Azonnali bekapcsolás","Auto shop mode","Area","Demó mód"];
...
var picOptions		= ["Képmód",
						...
						"A speciális beállítások","Kép visszaállítás"];
...
var smartTVOptions		= ["Smart TV portál","HbbTV","Megoszt és megtekint","Wi-Fi megjelenítése","Smart TV irányelvek",
    "Hálózati készenlét","smart TV visszaállítása"];
...
var eStickerTipWords = ["A tárhely 500 MB alá csökkent. Szeretne demó módban videókat törölni, hogy tárhelyet szabadítson fel?"];
