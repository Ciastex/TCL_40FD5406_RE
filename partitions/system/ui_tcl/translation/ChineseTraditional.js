var  all_country  = ["澳大利亞","奧地利","比利時","保加利亞","科迪亞","捷克","丹麥","芬蘭","法國","德國",
					 ...
					 "中國","台灣","巴西","加拿大","墨西哥","美國","韓國","罗马尼亚","越南"/*新添加的，底層結構體中沒有*/,"烏克蘭"/*新添加的，底層結構體中沒有*/,
					 ...
					 "馬爾他","黑山","喀麥隆","新加坡","馬來西亞","法屬喀裡多尼亞","苏里南共和国"," "," ","",
					"Antigua & Barbuda","St Lucia","Barbados","St Vincent","St Kitts & Nevis","Grenada","Trinidad & Tobago","Guyana","Puerto Rico","巴拿馬",
					"Dominica","Cuba","Honduras","Haiti","柬埔寨","津巴布韦","Dominican Republic","Bonaire","索马里","阿塞拜疆",
    				"Uganda","Rwanda","幾內亞","Burundi","阿布哈兹","Andorra","Anguilla","Antarctica","American Samoa","Aland Island",
    				"布基納法索","Bermuda","Brunei","Caribbean Netherlands","Saint Barthélemy","Bahamas","Bhutan","Bouvet Island","Botswana","Cocos (Keeling) Islands",
    				"Central African Republic","Cape Verde","Djibouti","Eritrea","Western Sahara","Falkland Islands","Federated States of Micronesia","Faroe Islands","加蓬","Cook Islands",
				...
				/*20*/"Jersey","Kiribati","Comoros","Cayman Islands","Liechtenstein","Lesotho","Monaco","Saint Barthélemy","Madagascar","馬裏",
    				"Macao","Martinique","Mauritania","Montserrat","Malawi","Namibia","尼日爾","Norfolk Island","Nauru","Papua New Guinea",
    				"Pitcairn Islands","Palau","Reunion Island","Solomon Islands","Seychelles","The Svalbard archipelago","Sierra Leone","San Marino","塞內加爾","South Sudan",
...
var chScanOptions = ["國家/區域","調諧器類型","自動搜索","自動更新","模擬手動掃描",["有線手動安裝","天線手動搜索","衛星手動調音"],"衛星地面設置","偏好網絡選擇","清除頻道列表","LCN"];
...
var initialHotkeys = ["返回","選擇","下一個","我同意"];
...
var screenSavers = ["無頻道資訊，請按OK鍵搜台！","無信號！","擾頻","只有數據","音頻節目","沒有音視頻","不可用","沒有圖文","沒有節目數據","節目已被鎖！","節目已被鎖！按確定鍵輸入你的密碼。","無節目說明","此節目需要家長指引，請輸入你的密碼。","頻道被鎖！","頻道已被鎖！請按確定鍵輸入密碼。","輸入被鎖！請按確定鍵輸入密碼。","不支持！","此設備暫不可用","輸入已被鎖！","無節目名稱","無功能","沒有字幕"];
...
var smartTVOptions = ["智能電視門戶","HbbTV","網路設備","無線互聯","免責聲明",                            "網路喚醒","重置","Cookie政策","隱私政策","數據刪除"];
...
var emailWord = "電子郵箱:";
var cookiePolicyTitle = "Cookie 原則 – 線上智慧電視機服務";
var cookiePolicyConditions = ["當您使用「公司」製造的智慧電視機和「公司」提供的「服務」時，「公司」尊重您的隱私權。許多網站和其他網際網路服務會使用 cookie，本智慧電視機會接受、儲存及傳送 cookie，以確保這些網站和服務能正常運作。 「公司」在提供您「服務」時也使用 cookie。「公司」在本 Cookie 原則中說明本智慧電視機設置了哪些 cookie，及您如何能管理這些 cookie。\n請注意，所有「公司」透過 cookie 或在其協助下收集及/或處理的個資均遵循本隱私權原則，您應同時閱讀本 Cookie 原則及本隱私權原則。\n1.什麼是 cookie？\nCookie 是可放置在本智慧電視機的一些小型文件檔。存取網站或使用電視台的紅色按鍵服務時，該網站或服務可在本智慧電視機中儲存 cookie。後續使用時，放置在本智慧電視機上的 cookie 會向該 cookie 放置者傳送資訊。Cookie 極為常見且許多網站和服務均會採用。每個 cookie 通常會包含 cookie 的來源網域名稱、cookie 的「壽命」和一個數值（通常是專屬號碼）。若想進一步了解 cookie 的解釋及其工作原理，請造訪 www.allaboutcookies.org。\nCookie 可分類成功能性 cookie 及非功能性 cookie。功能性 cookie 是提供本智慧電視機服務，及讓網站和其他服務在本智慧電視機上提供正確內容不可或缺的 cookie。其他 cookie 則屬非功能性 cookie。\n本 Cookie 原則涉及我們放置的 cookie 及第三方可透過本智慧電視機的「服務」放置的廣告 cookie。 本 Cookie 原則不涉及您使用本智慧電視機服務存取第三方網站、服務或應用程式時可放置的 cookie。針對這些 cookie，我們會將您引導至上述第三方的個別 cooki 原則。不過，本 Cookie 原則會說明如何刪除上述 cookie 的說明（參閱下方第 4 部分）。\n2.我們使用哪些非功能性 cookie？\n廣告：使用本智慧電視機服務時可能會提供視訊內和顯示性廣告。這些廣告可能由我們提供，或由我們的廣告伺服器擔任上述廣告協調角色，讓第三者透過伺服器或在其協調下提供。我們的廣告伺服器或第三方的廣告伺服器會在本智慧電視機上設置 cookie。廣告伺服器將藉此紀錄是否曾在本智慧電視機上提供廣告，或者是否有人使用本智慧電視機點擊廣告。我們會使用儲存在上述廣告 cookie 中的資訊，記住曾在本智慧電視機提供的廣告，藉此確保相同廣告不會在任何特定智慧電視機提供太多次，及確保履行與廣告合作夥伴的商業協議。我們絕不會將這些資訊用於特定廣告。此外，第三方可使用我們的廣告系統在本智慧電視機提供廣告，及在提供上述廣告時於本智慧電視機上放置 cookie。 \n這些 cookie 與其他 cookie 相同，會包含所提供廣告的相關資訊、提供該廣告的應用程式或網域的相關資訊，及您的 IP 位址。目的在記住特定廣告的顯示頻率，以避免相同廣告出現次數太多。可提供廣告的外部第三方廣告商也可使用 cookie 追蹤您在多個網站的活動，以提供符合您個人偏好的廣告。\n3.第三方網站\n當您透過本智慧電視機的智慧電視機服務進入第三方網站或服務時，該網站或服務可將 cookie 放置在本智慧電視機上，且該網站會儲存您與上述網站的互動。我們未要求或鼓勵上述活動，也不會使用此類資訊。若想進一步了解該網站如何運用此類資訊，請參閱該網站的 cookie 及隱私權原則。\n4.刪除 Cookie\n本智慧電視機的使用者介面允許您從本智慧電視機刪除全部的 cookie 和其他的本機瀏覽記錄。 強烈建議您在售出或贈出本智慧電視機前，先移除全部的 cookie 和儲存於本機的設定。\n5.聯絡我們\n若您對我們的 Cookie 原則或我們如何運用 cookie 有任何問題或意見 ，可寄送電子郵件至 Frsupport@tcl.com。\n版本：1.0\n"];
var privacyPolicyTitle = "隱私權原則 – 線上智慧電視機服務";
var privacyPolicyConditions = ["我們在處理您的個資時尊重您的隱私權。本隱私權原則說明負責收集、處理及使用涉及我們在您使用本智慧電視機服務（下稱「服務」）所收集相關個資的個體，及所收集個資的類型、用途和您在我們使用個資方面所享權利。 \n1. 資料控制者\n您在使用「服務」期間所提供個資將由深圳 TCL 新技術有限公司（地址： 中國廣東省深圳巿蛇口工業區工業中道中 5 號）（下稱「本公司）收集、處理及運用。但請注意，我們不對下方規定的所有資料處理活動負責。由於此處理與您使用我們的智慧電視機有關，本隱私權原則中仍會提及相關的活動。\n2.資料處理同意內容\n有些收集、處理及/或運用個資的活動需要取得您的同意。 \n若您已同意將個資作為改善本「服務」用途，您的同意內容將包含以下文字：\n「我同意就我的裝置啟動時間、DTV 頻道清單、最愛頻道清單、造訪時間和收看過頻道進行收集、處理及運用，用於分析使用者嗜好以改善「服務」及/或分析本公司每日/每月/每年的上線使用者數量，及與電視台分享此資訊。」\n若您已同意將個資作為依興趣個人化廣告用途，您的同意內容將包含以下文字：\n「我同意就我的用戶端類型和國家/地區進行收集、處理及運用，用於接收合適廣告。」\n同意屬自願性質，即使不同意仍可使用本服務。但您會看到未依個人偏好投放的廣告及其他內容。無論是否同意，「公司」仍保留在適用法範圍內就上述資料進行收集、處理及運用的權利。\n您可在未來任何時間撤消上述同意。您可拒絕將個資用於行銷、巿場或意見調查，及依據您需要個人化本服務。若想撤消同意及/或拒絕，請依所需變更本智慧電視機的隱私權設定。\n3.收集的個資\n無論是否同意，「公司」仍收集、處理及運用以下資料類別：\n裝置 ID：本智慧電視機儲存一組永久專屬號碼，作為您使用「服務」時識別及驗證之用。此號碼稱為裝置 ID。向您提供「服務」時會將此裝置 ID 提供給我們的服務合作夥伴。我們也會將此裝置 ID 提供給指定的內容合作夥伴作為驗證之用。當您使用內容合作夥伴提供的服務時，這些內容合作夥伴會使用此裝置 ID 驗證。\nIP 位址與 MAC 位址：連接至網際網路時，本智慧電視機會取得一組 IP 位址。當本智慧電視機每次向「服務」要求資訊或資料，我們會取得和處理此 IP 位址。若本智慧電視機透過路由器連線（例如連線至區域家用網路或區域無線網路），我們可收集和處理上述路由器的 IP 位址。本智慧電視機的每個網路介面均配置一組稱為 MAC 位址的專屬號碼。當本智慧電視機向「服務」要求資訊或資料，我們也會取得和處理此 MAC 位址。\n服務要求資料：任何時候當本智慧電視機連至網際網路並開啟電源後，會自動連接「服務」；「服務」是由我們的服務合作夥伴管理。本智慧電視機隨後會驗證是否已授權使用「服務」。為驗證目的，本服務會儲存關聯至本智慧電視機的一個或多個專屬數值識別器。連接至「服務」時，本智慧電視機會傳送所取得 IP 位址和特定裝置資訊（智慧電視機型號、軟體版本）以檢查軟體更新。\n「服務」設定：您可手動設定想在「服務」中顯示的應用程式；這是「服務」的一般功能性之一。我們的服務合作夥伴會儲存您的設定和使用「服務」期間設定的其他偏好。此資訊會連接至裝置 ID。\n裝置特定資訊：本智慧電視機儲存幾項與其本身相關的資訊以及其配置。此資訊包括本智慧電視機的類型、作業系統版本、面板解析度、專案 ID（即配置檔相關資訊）、使用者代理程式、瀏覽器名稱、瀏覽器版本及所設定的語言與國家/地區。我們會使用這些資訊，並會提供給我們的服務合作夥伴和內容合作夥伴。\n廣告：「服務」可能會提供廣告。這些廣告由我們、或由使用我們所提供廣告庫的第三方合作夥伴提供。所有廣告均依靠或經由我們的廣告伺服器提供，以履行提供廣告的協調責任。我們的廣告伺服器或第三方的廣告伺服器可在本智慧電視機上設置 cookie。若想進一步了解 cookie 的資訊，請參閱我們的 Cookie 原則。\n「服務」與內容合作夥伴網路流量：使用「服務」時，本智慧電視機會透過網際網路向「服務」要求資料。送出要求時，會將上述的 IP 位址和本智慧電視機的語言與國家/地區設定，傳送至我們的服務合作夥伴。我們的服務合作夥伴會依據自已的隱私權原則處理相關資料。\n使用第二螢幕：若使用我們的第二螢幕應用程式，我們會在我們的伺服器收集和處理應用程式上啟動的控制功能和國家/地區與語言設定、DTV 頻道表、節目時間表、裝置 ID、目前頻道、通訊協定版本和本智慧電視機的 IP 位址。我們的伺服器隨後會依照您在第二螢幕應用程式中的指示，控制本智慧電視機。\nHbbTV -「紅色按鍵」：TV 電台（下稱「電視台」）可隨其電視訊號傳送其他資訊。若本智慧電視機從上述其他資訊中接收到特定指令且已連接網際網路，本智慧電視機會從電視台網站下載圖片和小頁面並與資訊同時顯示；若想使用電視台提供的其他服務，請按遙控器的「紅色按鍵」。每次快速瀏覽時會進行這個動作。本智慧電視機從電視台網站下載圖片時會傳送個資，即 DTV 頻道表、目前頻道、事件資訊表、電視時間、本智慧電視機的 IP 位址和其儲存的 cookie（若有）。電視台負責收集、處理及/運用這些資料。此外，若透過「紅色按鍵」使用電視台提供的其他服務，電視台可收集其他的個資（例如觀賞的隨選影片、閱讀的新聞等）。\n4.我們處理及/或運用個資的目的\n以下是我們處理所收集資料的目的：\n提供「服務」：我們使用 IP 位址與 MAC 位址、裝置 ID、智慧電視機作業系統版本、智慧電視機客戶端類型和其面板解析度、專案 ID（即配置檔相關資訊）、DTV 頻道表、觀賞的頻道、時區、國家/地區與語言設定，使本智慧電視機能存取「服務」和內容合作夥伴提供的服務。用途包括（但不限於）驗證、提供所在位置服務（例如天氣預測）、處理濫用情形、管理安全性意外、監控「服務」可用性，及提供使用者偏好備份。\n驗證：我們為驗證目的使用裝置 ID 和 MAC 位址。\n軟體更新：本智慧電視機每次開啟電源時，會向我們提供 IP 位址、裝置 ID、軟體版本、本智慧電視機用戶端類型、專案 ID（即配置檔）、使用者 ID、序號，以提供合適的軟體更新。 \n提升「服務」：我們使用經過彙總且匿名的資料（即您和「服務」互動的相關資料），以提升「服務」的使用經驗。\n提供廣告：我們使用廣告 cookie 中的資訊，紀錄系統曾在本智慧電視機提供的廣告，目的在確保您不會收到太多類似的廣告，並使我們能履行對廣告合作夥伴的商業協議。在「服務」或內容合作夥伴網站上提供廣告的外部廣告商，經協商後也可使用 cookie 跨網站追蹤您，以提供符合您個人偏好的廣告。\n最佳化廣告：我們使用閱覽及點擊廣告的相關資料在「服務」中提供消費者最好的廣告經驗。\n折扣：我們向指定的內容合作夥伴提供裝置 ID，讓這些合作夥伴能辨識可向您免費提供現有隨選影片的範圍。\n法律執行：我們可能必須向執法機關或法院提供資料。發生此情況時，我們僅會在有搜查令或法院命令要求配合相關單位下提供資料。\n除非特定服務要求提供姓名及/或電子郵地址，否則可透過假名使用「服務」。\n5.接收者類別\n「公司」會在您使用「服務」期間與以下第三方分享您的個資：\n當您向智慧電視機服務的第三方提供商要求上述服務時（例如在本智慧電視機上啟動 Netflix 應用程式，我們可與 Netflix 分享您的 IP 位址、MAC 位址、軟體版本及電視機型名稱）。\n當您向第三方內容合作夥伴要求某些內容時（例如我們可與給 GoLive 服務的法人分享您的電視類型、IP 位址及語言設定）。\n「公司」會在您同意與上述第三方分享特定個資範圍內與這些第三方分享您的個資。\n當委外服務提供商以資料處理者身分協助「公司」提供「服務」時。\n「公司」僅會在法律要求的義務下與其他第三方（例如向法院或刑事檢控機關）分享您的個資，您同意此個別分享或此分享依適用法律合法。\n6.處理個資所在國家/地區\n「公司」及/或部分上列個資接收者可能不在歐洲經濟區域內（即以下國家/地區：中國、美國）。因此，您個資可能會在不認為可滿足與歐洲議會與歐洲理事會於 1995 年 10 月 24 日頒布 95/46/EC 指令等級個資保護的國家/地區中處理；該指令與處理個資及自由移動個資有關。\n7.您的權益\n您可聯絡「公司」以取得您交由「公司」處理的個資，及/或行使您關於存取、改正、刪除及拒絕您個資的法定權益；及/或拒絕您的個資用於行銷及/或巿場或意見調查。\n8.變更隱私權原則\n我們可依需要修訂本隱私權原則以提升「服務」 - 例如採用新技術或推出新服務。我們保留隨時變更或補充本隱私權原則的權利。\n9.聯絡資訊\n若您有任何關於本隱私權原則的問題或想申訴個資處理不當，請透過以下詳細聯絡資訊之一與我們聯絡：\n電子郵件：FRsupport@tcl.com\n版本：1.0\n"];
var privacyPolicyTerms = [
    "啟用智能電視服務",
    "我同意收集、處理和使用我設備的啟動時間、頻道列表、喜好列表、訪問時間和頻道觀看記錄等資訊，用於分析用戶習慣，改進服務；或者分析每天/月/年有多少線上用戶；以及共用這些資訊給電視臺。",
    "啟用推薦服務",
    "啟用移動設備的傳屏應用。",
    "啟用軟體自動更新服務。",
    "啟用FreeviewPlay服務。"
...
var privacyPolicyRemind = "請在設置中選中相應的複選框。";
var set = "設置";
var copyShopDemoTips = ["連接到USB，是否要將視頻複製到閃存？","將視頻複製到閃存","該視頻已成功複製！","視頻複製錯誤！"];
var activateTVWords = ["激活你的電視","請輸入驗證碼。","激活電視後享受更多服務","掃描QR碼以獲取驗證碼。","您還可以獲取驗證碼如下：","撥打1800588880，然後提供SN獲取驗證碼。","客戶中心","請填寫信息，您將獲得保修服務。"];
var dataDeletionWords = ["刪除您的個人信息","提示：勾選後，與智能電視相關的用戶數據將會在一個月後別刪除。請注意，存儲於電視上的瀏覽數據不會通過該選項被刪除。","不再上報數據到智能電視服務器","提示：勾選後，與智能電視相關的用戶數據不會再上報到服務器，你的電視可能不會再收到廠商給你推薦的服務。","如果您想了解更多信息，請訪問網站www.tcl.eu"];
var miracastWords = ["無線互聯","把安卓手機的畫面投屏至電視","點擊連接","此功能只能在安卓手機上使用"];
var miracastTips = ["連接步驟","打開系統設置","更多連接方式\n/其他無線連接","選擇無線顯示","選中點擊連接\n等待發現設備"];
var eWarrantyCardWords=["電子保卡","激活日期:"];