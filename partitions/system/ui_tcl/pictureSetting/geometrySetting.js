var userPicGeoName             = [top.picOptions[14],top.manualAuto[1],top.picGeoOptions[1],top.picGeoOptions[2],top.picGeoOptions[3],top.picGeoOptions[4]];
...
function autoAdjustGeometry()//显示picture preset 列表
{
	geometryValue=1;
...
function showAdjustBar()//显示待调整进度的选项的进度条
{
	...
	switch(positionV)
	{
		case 1:
		{
			...
			progDivs[0].style.width=9*geoHPosition+"px";
			progDivs[2].style.width=900-9*geoHPosition+"px";
		...
		case 2:
		{
			...
			$("adjustProgMain").getElementsByTagName("span")[0].innerHTML=userPicGeoName[positionV+1];
			var progDivs=$("adjustProgBar").getElementsByTagName("div");
			progDivs[0].style.width=9*geoVPosition+"px";
			progDivs[2].style.width=900-9*geoVPosition+"px";
		...
		case 3:
		{
			...
			$("adjustProgMain").getElementsByTagName("span")[0].innerHTML=userPicGeoName[positionV+1];
			var progDivs=$("adjustProgBar").getElementsByTagName("div");
			progDivs[0].style.width=(900*geoClock)/255+"px";
			progDivs[2].style.width=900-(900*geoClock)/255+"px";
		...
		case 4:
		{
			...
			$("adjustProgMain").getElementsByTagName("span")[0].innerHTML=userPicGeoName[positionV+1];
			var progDivs=$("adjustProgBar").getElementsByTagName("div");
			progDivs[0].style.width=9*geoPhase+"px";
			progDivs[2].style.width=900-9*geoPhase+"px";
