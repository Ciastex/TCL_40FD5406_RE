...
var tcl_util = (typeof(TUtil) !=  "undefined" ) ? TUtil : Util;
tcl_util.setEnv("TBROWSER_IME_SWITCH", "1");
...
function initSetRegion()
{
  ...
  imagepath = imagepath.replace("framework.html", "");
}
...
var ime_Keyboard = (function ()
{
    ...
    function keyboard(buttonProxy)
    {
	    ...
	    document.addEventListener("click",ime_stopWebEventListener,true);
            
            keboardTransportView = document.createElement("div");
            keboardTransportView.style.cssText = " height: 720px;width: 1280px;bottom:0px;position:fixed;z-index: 2147483640;background-color: rgba(0,0,0,0)";
            ...
            ime_keyboard_ui.style.cssText = "width: 1280px; height: 311px; z-index: 2147483641; bottom:0px;position:fixed";
            ...
            for(var i = 0; i < rows-1; i++)
            {
                for(var j = 0; j < columns; j++)
                {
...

                    {
                        ...
                        ime_keyboard_letters.style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                    }else if(columns == 11 && rows == 5)//5\u884C\u952E\u76D8\u7684\u6837\u5F0F
                    {
                        ...
                        ime_keyboard_letters.style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/normal_letters.png); width: 87px; height: 41px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                    }
            ...
            {
                ime_getEID(_languageJson[rows-1][0].input_id).style.cssText = "outline:none; width: 128px; height: 61px; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][2].input_id).style.cssText = "outline:none; width: 128px; height: 61px; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][3].input_id).style.cssText = "outline:none; width: 420px; height: 61px; background-image:url("+imagepath+"images/ime/normal_space.png); border: 0px; background-color: transparent;margin:0;";
                ime_getEID(_languageJson[rows-1][8].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][9].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/setting.png); width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
                ime_getEID(_languageJson[rows-1][10].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/enter.png); width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
                //space\u6309\u952E\u53E0\u52A0\u5C42
            ...
            }else if(columns == 11 && rows == 4 && _languageJson[rows-1][3].repeat_flag == 2)//4\u884C\u952E\u76D8\u7A7A\u683C\u53602\u4E2A\u5B57\u7B26\u7684\u6837\u5F0F
            {
                ime_getEID(_languageJson[rows-1][0].input_id).style.cssText = "outline:none; width: 128px; height: 61px; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][2].input_id).style.cssText = "outline:none; width: 128px; height: 61px; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][3].input_id).style.cssText = "outline:none; width: 172px; height: 61px; background-image:url("+imagepath+"images/ime/normal_space_2.png); border: 0px; background-color: transparent;margin:0;";
                ime_getEID(_languageJson[rows-1][5].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][6].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][7].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][8].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][9].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/setting.png);width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
                ime_getEID(_languageJson[rows-1][10].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/enter.png); width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
                //space\u6309\u952E\u53E0\u52A0\u5C42
            ...
            {
                ime_getEID(_languageJson[rows-1][0].input_id).style.cssText = "outline:none; width: 130px; height: 41px; background-color: transparent; background-image: url("+imagepath+"images/french/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][2].input_id).style.cssText = "outline:none; width: 130px; height: 41px; background-color: transparent; background-image: url("+imagepath+"images/french/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][3].input_id).style.cssText = "outline:none; width: 436px; height: 41px; background-image:url("+imagepath+"images/french/normal_space.png); border: 0px; background-color: transparent;margin:0;";
                ime_getEID(_languageJson[rows-1][8].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/normal_letters.png); width: 87px; height: 41px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
                ime_getEID(_languageJson[rows-1][9].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/setting.png); width: 87px; height: 41px; border: 0px; padding: 0px;margin:0;";
                ime_getEID(_languageJson[rows-1][10].input_id).style.cssText = "outline:none; width: 87px; height: 41px; border: 0px; padding: 0px;background-color: transparent;background-image: url("+imagepath+"images/french/enter.png);margin:0;";
                //space\u6309\u952E\u53E0\u52A0\u5C42
            ...
            }else if(columns == 12 && rows == 4)
            {
		     ...
		     ime_getEID(_languageJson[rows - 1][3].input_id).style.cssText = "outline:none; width: 420px; height: 61px; background-image:url("+imagepath+"images/ime/normal_space.png); border: 0px; background-color: transparent;margin:0;";
		     ime_getEID(_languageJson[rows - 1][8].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
		     ime_getEID(_languageJson[rows - 1][9].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/normal_letters.png); width: 87px; height: 61px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
		     ime_getEID(_languageJson[rows - 1][10].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/setting.png); width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
		     ime_getEID(_languageJson[rows - 1][11].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/ime/enter.png); width: 87px; height: 61px; border: 0px; padding: 0px;margin:0;";
		     ime_getEID(_languageJson[rows - 1][3].li_id).style.backgroundImage = "url("+imagepath+"images/ime/space.png)";
            }else if(columns == 12 && rows == 5)
            {
               ime_getEID(_languageJson[rows - 1][0].input_id).style.cssText = "outline:none; width: 130px; height: 41px; background-color: transparent; background-image: url("+imagepath+"images/french/normal_language.png); border: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
   			...
   			ime_getEID(_languageJson[rows - 1][3].input_id).style.cssText = "outline:none; width: 436px; height: 41px; background-image:url("+imagepath+"images/french/normal_space.png); border: 0px; background-color: transparent;margin:0;";
    			ime_getEID(_languageJson[rows - 1][8].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/normal_letters.png); width: 87px; height: 41px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
    			ime_getEID(_languageJson[rows - 1][9].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/normal_letters.png); width: 87px; height: 41px; border: 0px; padding: 0px; font-size: 20px; font-weight:bold; color: white;margin:0;";
    			ime_getEID(_languageJson[rows - 1][10].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/setting.png); width: 87px; height: 41px; border: 0px; padding: 0px;margin:0;";
    			ime_getEID(_languageJson[rows - 1][11].input_id).style.cssText = "outline:none; background-color: transparent; background-image: url("+imagepath+"images/french/enter.png); width: 87px; height: 41px; border: 0px; padding: 0px;margin:0;";
    			ime_getEID(_languageJson[rows - 1][3].li_id).style.backgroundImage = "url("+imagepath+"images/french/space.png)";
            }
...
var ime_arabic_keyboard_json = [
    ...
    [
        ...
        {"li_id":"ime_keyboard_language_button_number","input_id":"ime_keyboard_letters_number","input_value":"123#","input_name":"number","repeat_flag":1,"focus_img":"url(images/ime/focus_languages.png)","normal_img":"url(images/ime/normal_language.png)"},
        {"li_id":"ime_keyboard_space","input_id":"ime_keyboard_letters_space","input_value":" ","input_name":"space","repeat_flag":4,"focus_img":"url(images/ime/focus_space.png)","normal_img":"url(images/ime/normal_space.png)"},
        {"li_id":"ime_keyboard_space","input_id":"ime_keyboard_letters_space","input_value":" ","input_name":"space","repeat_flag":0,"focus_img":"url(images/ime/focus_space.png)","normal_img":"url(images/ime/normal_space.png)"},
        {"li_id":"ime_keyboard_space","input_id":"ime_keyboard_letters_space","input_value":" ","input_name":"space","repeat_flag":0,"focus_img":"url(images/ime/focus_space.png)","normal_img":"url(images/ime/normal_space.png)"},
        {"li_id":"ime_keyboard_space","input_id":"ime_keyboard_letters_space","input_value":" ","input_name":"space","repeat_flag":0,"focus_img":"url(images/ime/focus_space.png)","normal_img":"url(images/ime/normal_space.png)"},
        {"li_id":"ime_keyboard_space","input_id":"ime_keyboard_letters_space","input_value":" ","input_name":"space","repeat_flag":0,"focus_img":"url(images/ime/focus_space.png)","normal_img":"url(images/ime/normal_space.png)"},
...
var ime_Setting = (function ()
{
     ...
     *\u95ED\u5305\u5355\u4F8B\u6A21\u5F0F
     */
    function setting(ime_g_setting)
    {
       ...
       //     setDivBgRight.style.opacity="0.92";
        ...
        function ime_change_language()//\u6309language button\u5207\u6362\u8BED\u8A00
        {
            ...
            ime_set_press_language(ime_Languages.getLanguagesArray()[ime_countryList[i]]);
            ime_display_language(ime_Languages.getLanguagesArray()[ime_countryList[i]]);
    ...
    return {
        getInstance: function (ime_g_setting)
        {
            if (instance === undefined)
            {
                instance =  setting(ime_g_setting);
            }
            return instance;
        }
    };
    ...
    function candidate()
    {
        ...
        function ime_drawCandidateBar()
        {
            ...
            for(var i = 1;i<=ime_MAX_NUM_LINE;i++)
            {
                ...
                ime_keyboard_char_span.style.cssText= "position: absolute; width: 172px; height: 50px; top: 2px; text-align: center; line-height: 45px; color: #ffffff; overflow: hidden; font-size: 30px; -webkit-marquee-direction: backwards; -webkit-marquee-style: scroll; -webkit-marquee-speed: fast; -webkit-marquee-increment: small; -webkit-marquee-repetition: infinite; marquee-direction: forward; marquee-style: scroll; marqueepeed: fast; marquee-play-count: infinite";
                ime_keyboard_char_span.innerHTML=" ";
                ime_keyboard_char_span.style.left=i*200 - 70+"px";
            ...
            ime_keyboard_char_focus.style.cssText= "position: absolute;  top: 0px; left:200px;width: 172px; height: 61px; ";
 ...
 //           ime_showstring();
        ...
        function ime_char_enter()
        {
            ...
            for(var i = 0; i < ime_mulCharList[ime_drawposition].innerHTML.length; i++)
            {
                ...
                tcl_util.sendKeyboardCHNEvent(ime_mulCharList[ime_drawposition].innerHTML.charCodeAt(i));
            }
 ...
 //           ime_showstring();
        ...
        function ime_submitString()
        {
            ...
            for(var i = 0; i < ime_inputstring.length; i++)
            {
                ...
                tcl_util.sendKeyboardCHNEvent(ime_inputstring.charCodeAt(i));
            }
            ime_back();
        }
...
//\u952E\u76D8\u521D\u59CB\u5316\u51FD\u6570
    function ime_keyboard_Onload()
    {
        ...
        ime_keyboard = ime_Keyboard.getInstance(ime_button_proxy);
          ...
          //setting\u7C7B
    ime_setting = ime_Setting.getInstance(ime_g_setting);

    if(ime_g_setting.getProperty(ime_is_tv_first_on,"0")=="0")
    {
        //window.alert("first tv on");
     
        ime_set_press_language(ime_Languages.getLanguage("ENGLISH"));
        ime_display_language(ime_Languages.getLanguage("ENGLISH"));
    ...
    }else
    {
         ...
         ime_set_press_language(ime_Languages.getLanguagesArray()[ime_g_setting.getProperty(ime_setting.getCurCountry(),0)]);
        ime_display_language(ime_Languages.getLanguagesArray()[ime_g_setting.getProperty(ime_setting.getCurCountry(),0)]);
    }
...
function ime_keyDown(evt)
{
    ...
    switch(code){
        case 1001:
            tcl_util.setEnv("TBROWSER_IME_STATE", "1");
            ime_keyboard_Onload();
            break;
        case 39:
...
function ime_stopWebEventListener(event)
{
...
function ime_closeKeyBoard()//\u9000\u51FA\u591A\u529F\u80FD\u8F93\u5165\u6CD5
{
    ...
    document.removeEventListener("click",ime_stopWebEventListener,true);
    ...
    tcl_util.setEnv("TBROWSER_IME_STATE", "0");
