...
function doContactUs()
{
    ...
    contactUsSpanList[9].innerHTML = swVersion;        //Model name
    contactUsSpanList[10].innerHTML =uId;    //Software versio
    contactUsSpanList[11].innerHTML = pId;         //User ID
    contactUsSpanList[12].innerHTML = cType;        //Project ID
    contactUsSpanList[13].innerHTML = wLessMac;      //Client type

    contactUsSpanList[14].innerHTML = netflix;    //wireless mac address
...
function initCallCenter(callKey)
{
    ...
    swVersion = contactUs[7] + " " + factory.getProductInfo().swName;   //Software version
    ...
    if(isTCL)     //TCL
    {
        ...
        switch(callKey + "")
        {
            ...
            case    "9":call = "211 73749050";break;  //German
