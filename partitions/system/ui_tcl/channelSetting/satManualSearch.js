...
/* definition for sattellite*/
var E_FPI_SATELLITE_LNB_FREQ_AUTO = 0;
var	E_FPI_SATELLITE_LNB_FREQ_5150 = 1;
var	E_FPI_SATELLITE_LNB_FREQ_5750 = 2;
var	E_FPI_SATELLITE_LNB_FREQ_5950 = 3;
var	E_FPI_SATELLITE_LNB_FREQ_9750 = 4;
var	E_FPI_SATELLITE_LNB_FREQ_10000 = 5;
var	E_FPI_SATELLITE_LNB_FREQ_10050 = 6;
var	E_FPI_SATELLITE_LNB_FREQ_10450 = 7;
var	E_FPI_SATELLITE_LNB_FREQ_10600 = 8;
var	E_FPI_SATELLITE_LNB_FREQ_10700 = 9;
var	E_FPI_SATELLITE_LNB_FREQ_10750 = 10;
var	E_FPI_SATELLITE_LNB_FREQ_11250 = 11;
var	E_FPI_SATELLITE_LNB_FREQ_11300 = 12;
var	E_FPI_SATELLITE_LNB_FREQ_5150_5750 = 13;
var	E_FPI_SATELLITE_LNB_FREQ_5750_5150 = 14;
var	E_FPI_SATELLITE_LNB_FREQ_9750_10600 = 15;
var	E_FPI_SATELLITE_LNB_FREQ_11475 = 16;
var	E_FPI_SATELLITE_LNB_FREQ_9750_10700 = 17;
var	E_FPI_SATELLITE_LNB_FREQ_9750_10750 = 18;
var	E_FPI_SATELLITE_LNB_FREQ_MAX = 19;

var realLnbFreq = 9750000;
...
{//console.log("in auto Search keyproc");
	var ret = true;
...
function toDown()
{
	console.log("in toDown focusOn = " + focusOn + ",satAntennaType = " + satAntennaType + ",list_position_h = " + list_position_h);
		...
		if(satAntennaType == 0)
		{
			switch(list_position_h)
			{
				...
				case 2:
					...
					break;
				case 3:
					console.log("in left strPosition 0 = " + strPosition);
					if(strPosition <= 0)
					{
						if(nowSatelliteInfo.symbolRate.length == SYMBOL_RATE_MAX_LENGTH)
						{
							console.log("in left symbol max strPosition = " + strPosition);
					...
					console.log("in left strPosition = " + strPosition);
					sliceStringToTags(sybContentSpanList,nowSatelliteInfo.symbolRate,strPosition,strFocusFlag,SYMBOL_RATE_MAX_LENGTH);
					break;
				case 4:
...
function doEnter()
{
	//console.log("in doEnter focusOn = " + focusOn + ",isSearch = " + isSearch);
	//console.log("in satManualSearch doEnter is top.preTempPage is "+top.preTempPage+"top.g_temp is "+top.g_temp);
...
{
	console.log("in showSatEditFocus");
	if(satAntennaType == 0)
	{
		if(value <= 4)
		{
	...
	console.log("in showSatEditFocus end");
}
...
function updateInfo(id)
{
    switch (id)
    {
		case 0:
		{
			...
			console.log("get scanningInfo = " + scanningInfo);
			cutScanningInfo(scanningInfo);//将scanningInfo切分并保存到响应的变量中
			
			if(progress > 100)
			{
				console.log("error in updateInfo  ------- progress = " + progress);
				return;
			}
...
{
	console.log("in initScanForm  " );
	var wrongParamFlag = 0;
	var freq = 0;
	freq = getLocalFrequency(nowSatelliteInfo.lNBFreq,parseInt(nowSatelliteInfo.frequency));
	...
	if(wrongParamFlag == 1)
	{
		$("scanStatus").innerHTML = scanStatusWords[3];
	}
	else
	{
	...
	$("progressRight").style.width = parseInt((100 - progress)*PROGRESS_WIDTH/100,10) + "px";
	$("progressValue").innerHTML = progress + "%";
	$("stop").style.border = "medium solid "+top.uiColourStyle;
	if(wrongParamFlag == 1)
	{
		$("stop").innerHTML = top.initialHotkeys[0];
		isSearch = 0;
		top.g_scanStatus = 0;
	}
	else
	...
	console.log("in initScanForm  end" );
}
function calculateLocalFreq(satFreq,lnbFreq) 
{
	channel.testLog("zenglm satFreq is "+satFreq+" and lnbFreq is "+lnbFreq);
	return ((lnbFreq>=9750000) ? (satFreq-lnbFreq ) : (lnbFreq-satFreq))
}
function mwAndUILnbFreqConvert(source,dir) //dir 0: mw to ui; 1: ui to mw
{
	var lnbFreqType;
	if(dir == 1)
	{
	  switch(source)
	  {
		  case 0: //EN_SATELLITE_LNB_FREQ_UNIVERSAL
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_9750_10600;
			  break;
		  case 3: //EN_SATELLITE_LNB_FREQ_5150
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_5150;
			  break;
		  case 4: //EN_SATELLITE_LNB_FREQ_5750;
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_5750;
			  break;
		  case 5://EN_SATELLITE_LNB_FREQ_9750;
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_9750;
			  break;			
		  case 6://EN_SATELLITE_LNB_FREQ_10600;
			  lnbFreqType =  E_FPI_SATELLITE_LNB_FREQ_10600;
			  break;			
		  case 7://EN_SATELLITE_LNB_FREQ_10750;
			  lnbFreqType =  E_FPI_SATELLITE_LNB_FREQ_10750;
			  break;
		  case 8://EN_SATELLITE_LNB_FREQ_11250;
			  lnbFreqType =  E_FPI_SATELLITE_LNB_FREQ_11250;
			  break;			
		  case 9://EN_SATELLITE_LNB_FREQ_11300;
			  lnbFreqType =  E_FPI_SATELLITE_LNB_FREQ_11300;
			  break;			
		  case 10: //EN_SATELLITE_LNB_FREQ_11475;
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_11475;
			  break;			
		  case 2://EN_SATELLITE_LNB_FREQ_9750_10700;
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_9750_10700;
			  break;			
		  case 1://EN_SATELLITE_LNB_FREQ_9750_10750;
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_9750_10750;
			  break;
		  default:
			  lnbFreqType = E_FPI_SATELLITE_LNB_FREQ_9750_10600;//EN_SATELLITE_LNB_FREQ_UNIVERSAL;
			  break;
	  }
	}
	else if(dir == 0)
...
function getLimitedFrequency(LnbType,lnbFrequency)
{
	var lowFrequency, highFrequency;
	var lnbFreqLow  = [0,5150000,5750000,5950000,9750000,10000000,10050000,10450000,
							10600000,10700000,10750000,11250000,11300000,5150000,5750000,9750000,11475000,9750000,9750000];
	var lnbFreqHigh = [0,5150000,5750000,5950000,9750000,10000000,10050000,10450000,
								10600000,10700000,10750000,11250000,11300000,5750000,5150000,10600000,11475000,10700000,10750000];
	var LnbFreqType = mwAndUILnbFreqConvert(LnbType,1);
	channel.testLog("zenglm LnbFreqType is "+LnbFreqType);
	switch(LnbFreqType)
	{
		case E_FPI_SATELLITE_LNB_FREQ_AUTO://auto test lnb frequency mode
			if((lnbFrequency>=10700000) &&
				(lnbFrequency<11700000))
			{
				realLnbFreq = 9750000;
				if((lnbFrequency-9750000) > 2150000)
				{
					lnbFrequency = 9750000 + 2150000;
				}
				else if((lnbFrequency-9750000) < 950000)
				{
					lnbFrequency = 9750000 + 950000;
				}
				return lnbFrequency;
			}

			if((lnbFrequency>=11700000) &&
				(lnbFrequency<12750000))
			{
				realLnbFreq = 10600000;
				if((lnbFrequency-10600000) > 2150000)
				{
					lnbFrequency = 10600000 + 2150000;
				}
				else if((lnbFrequency-10600000) < 950000)
				{
					lnbFrequency = 10600000 + 950000;
				}
				return lnbFrequency;
			}
			
			if(lnbFrequency<5150000)
			{
				realLnbFreq = 5150000;
				if((5150000 -lnbFrequency) > 2150000)
				{
					lnbFrequency = 5150000 - 2150000;
				}
				else if((5150000 -lnbFrequency) < 950000)
				{
					lnbFrequency = 5150000 - 950000;
				}
				return lnbFrequency;
			}


			lowFrequency = lnbFrequency-2150000;
			highFrequency = lnbFrequency-950000;

			for(LnbFreqType=E_FPI_SATELLITE_LNB_FREQ_10700;LnbFreqType<E_FPI_SATELLITE_LNB_FREQ_MAX;LnbFreqType++)
			{
				if((lowFrequency<=lnbFreqLow[LnbFreqType]) &&
					(highFrequency>=lnbFreqLow[LnbFreqType]))
				{
					realLnbFreq = lnbFreqLow[LnbFreqType];
					if((lnbFrequency-lnbFreqLow[LnbFreqType]) > 2150000)
					{
						lnbFrequency = lnbFreqLow[LnbFreqType] + 2150000;
					}
					else if((lnbFrequency-lnbFreqLow[LnbFreqType]) < 950000)
					{
						lnbFrequency = lnbFreqLow[LnbFreqType] + 950000;
					}
					return lnbFrequency;
				}
			}
			...
			return lnbFrequency;
		case E_FPI_SATELLITE_LNB_FREQ_5150:
		case E_FPI_SATELLITE_LNB_FREQ_5750:
		case E_FPI_SATELLITE_LNB_FREQ_5950:
			realLnbFreq = lnbFreqLow[LnbFreqType];
			if((lnbFreqLow[LnbFreqType] - 9750000) >= 0)
			{
				if((lnbFrequency-lnbFreqLow[LnbFreqType]) > 2150000)
				{
					lnbFrequency = lnbFreqLow[LnbFreqType] + 2150000;
			...
			{
				if((lnbFreqLow[LnbFreqType] -lnbFrequency) > 2150000)
				{
					lnbFrequency = lnbFreqLow[LnbFreqType] - 2150000;
				}
				else if((lnbFreqLow[LnbFreqType] -lnbFrequency) < 950000)
				{
					lnbFrequency = lnbFreqLow[LnbFreqType] - 950000;
				}
			}
			return lnbFrequency;
		case E_FPI_SATELLITE_LNB_FREQ_9750:
		case E_FPI_SATELLITE_LNB_FREQ_10000:
		case E_FPI_SATELLITE_LNB_FREQ_10050:
		case E_FPI_SATELLITE_LNB_FREQ_10450:
		case E_FPI_SATELLITE_LNB_FREQ_10600:
		case E_FPI_SATELLITE_LNB_FREQ_10700:
		case E_FPI_SATELLITE_LNB_FREQ_10750:
		case E_FPI_SATELLITE_LNB_FREQ_11250:
		case E_FPI_SATELLITE_LNB_FREQ_11300:
		case E_FPI_SATELLITE_LNB_FREQ_11475:
			realLnbFreq = lnbFreqLow[LnbFreqType];
			if((lnbFreqLow[LnbFreqType] - 9750000) >= 0)
			{
				if((lnbFrequency-lnbFreqLow[LnbFreqType]) > 2150000)
			...
			return lnbFrequency;
		case E_FPI_SATELLITE_LNB_FREQ_5150_5750:
			if((lnbFrequency>=(5150000-1460000)) &&
				(lnbFrequency<=(5150000-950000)))
			{
				realLnbFreq = lnbFreqLow[LnbFreqType];
				if((lnbFreqLow[LnbFreqType] - 9750000) >= 0)
			...
			{
				realLnbFreq = lnbFreqHigh[LnbFreqType];
				if((lnbFreqHigh[LnbFreqType] - 9750000) >= 0)
				{
					if((lnbFrequency-lnbFreqHigh[LnbFreqType]) > 2150000)
					{
						lnbFrequency = lnbFreqHigh[LnbFreqType] + 2150000;
					}
					else if((lnbFrequency-lnbFreqHigh[LnbFreqType]) < 950000)
					{
						lnbFrequency = lnbFreqHigh[LnbFreqType] + 950000;
					}
				}
				else
				{
					if((lnbFreqHigh[LnbFreqType] -lnbFrequency) > 2150000)
					{
						lnbFrequency = lnbFreqHigh[LnbFreqType] - 2150000;
					}
					else if((lnbFreqHigh[LnbFreqType] -lnbFrequency) < 950000)
					{
						lnbFrequency = lnbFreqHigh[LnbFreqType] - 950000;
					}
				}
		...
		case E_FPI_SATELLITE_LNB_FREQ_5750_5150:
			if((lnbFrequency>=(5150000-1460000)) &&
				(lnbFrequency<=(5150000-950000)))
			{
				realLnbFreq = lnbFreqLow[LnbFreqType];
		...
		case E_FPI_SATELLITE_LNB_FREQ_9750_10600:
		case E_FPI_SATELLITE_LNB_FREQ_9750_10700:
		case E_FPI_SATELLITE_LNB_FREQ_9750_10750:
			if( lnbFrequency  < 11700000)
			{
				realLnbFreq = lnbFreqLow[LnbFreqType];
				if((lnbFreqLow[LnbFreqType] - 9750000) >= 0)
			...
			break;
		default:
			if(lnbFreqHigh[LnbFreqType]>=5150000)
			{
				realLnbFreq = lnbFreqHigh[LnbFreqType];
				if((lnbFreqHigh[LnbFreqType] - 9750000) >= 0)
				{
...
function getLocalFrequency(LnbType,lnbFrequency)
{
	var lowFrequency, highFrequency;
	var lnbFreqLow  = [0,5150000,5750000,5950000,9750000,10000000,10050000,10450000,
							10600000,10700000,10750000,11250000,11300000,5150000,5750000,9750000,11475000,9750000,9750000];
	...
	switch(LnbFreqType)
	{
		case E_FPI_SATELLITE_LNB_FREQ_AUTO://auto test lnb frequency mode
			...
			{
				realLnbFreq = 10600000;
				return (lnbFrequency-10600000);
			}
			
			if(lnbFrequency<5150000)
			{
				realLnbFreq = 5150000;
				return (5150000 -lnbFrequency);
			}
			...
			for(LnbFreqType=E_FPI_SATELLITE_LNB_FREQ_10700;LnbFreqType<E_FPI_SATELLITE_LNB_FREQ_MAX;LnbFreqType++)
			{
				...
				{
					realLnbFreq = lnbFreqLow[LnbFreqType];
					return (lnbFrequency-lnbFreqLow[LnbFreqType]);
				}
			}
		...
		case E_FPI_SATELLITE_LNB_FREQ_5950:
			realLnbFreq = lnbFreqLow[LnbFreqType];
			return calculateLocalFreq(lnbFrequency,lnbFreqLow[LnbFreqType]);
		case E_FPI_SATELLITE_LNB_FREQ_9750:
		case E_FPI_SATELLITE_LNB_FREQ_10000:
		case E_FPI_SATELLITE_LNB_FREQ_10050:
		case E_FPI_SATELLITE_LNB_FREQ_10450:
		...
		case E_FPI_SATELLITE_LNB_FREQ_5150_5750:
			...
			{
				realLnbFreq = lnbFreqHigh[LnbFreqType];
				return calculateLocalFreq(lnbFrequency,lnbFreqHigh[LnbFreqType]);
			}
		case E_FPI_SATELLITE_LNB_FREQ_5750_5150:
			if((lnbFrequency>=(5150000-1460000)) &&
				(lnbFrequency<=(5150000-950000)))
		...
		case E_FPI_SATELLITE_LNB_FREQ_9750_10750:
			...
			break;
		default:
			if(LnbFreqType>=5150000)
			{
				realLnbFreq = LnbFreqType;
				return calculateLocalFreq(lnbFrequency,LnbFreqType);
			}
	}
...
{
	console.log("in setSatInfo list_position_h = " + list_position_h);
	if(satAntennaType == 0)
	{
		switch(list_position_h)
		{
...
function checkNumInput(keycode)
{
	...
	if(satAntennaType == 0)
	{
		if(list_position_h == 2)
		{
			...
			//freqThresholdCheck(nowSatelliteInfo.frequency);
			nowSatelliteInfo.frequency = getLimitedFrequency(nowSatelliteInfo.lNBFreq,parseInt(nowSatelliteInfo.frequency));
			sliceStringToTags(freqContentSpanList,nowSatelliteInfo.frequency,strPosition,strFocusFlag,FREQUENCY_MAX_LENGTH);
		}
		else if(list_position_h == 3)
		{
...
{
	console.log(" in inputNumToNumber numString = " + numString + ",index = " + index + ",cursorFlag = " + cursorFlag + ",num = " + num + ",maxLength = " + maxLength);
	var str = "" + numString;
...
{
	console.log("in sliceStringToTags string=" + string + ",index=" + index + ",cursorFlag=" + cursorFlag + ",maxLength=" + maxLength);
	console.log("in sliceStringToTags strPosition=" + strPosition + ",strFocusFlag=" + strFocusFlag);
	...
	console.log("in sliceStringToTags str=" + str + ",str.length=" + str.length);
	if(index < 0)
	{
		if(str.length == 0)
		{
	...
	{
		console.log("in sliceStringToTags index == 0");
		if(str.length == 0)
		{
			tagList[0].innerHTML = "";
			tagList[1].innerHTML = "_";
		...
		{
			console.log("in sliceStringToTags str.length > 0");
			if(cursorFlag == 0)//字符
			{
				tagList[0].innerHTML = "";
				...
				strPosition = 0;
				strFocusFlag = 0;
				console.log("in sliceStringToTags end  cursorFlag == 0");
			}
			else
			{
				tagList[0].innerHTML = "";
	...
	console.log("in sliceStringToTags strPosition=" + strPosition);
	//return str;
}
/*
...
{
	console.log(" in deleteCharFromString string = " + string + ",index = " + index + ",cursorFlag = " + cursorFlag + ",maxLength = " + maxLength );
	var str = "" + string;
	if(str.length > maxLength)
	{
		return;//str = str.substring(0,maxLength);
...
{
	console.log(" in insertCharPreToString string = " + string + ",index = " + index + ",cursorFlag = " + cursorFlag + ",maxLength = " + maxLength);
	var str = "" + string;
	if(str.length >= maxLength)
	{
		return;//str = str.substring(0,maxLength);
...
function initSatelliteEdit(infoIndex)
{
	...
	console.log("in satellite edit 0 infoindex = " + infoIndex);
	strPosition = 0;
	strFocusFlag = 0;
	list_position_h = 0;
	...
	console.log("in satellite edit 1");
	...
	sybContentSpanList[2].innerHTML = "";
	$("polarizationSpan").innerHTML = polarization[nowSatelliteInfo.polarization];
	console.log("in satellite edit 2");
...
function init()
{
    ...
    console.log("***** satManualSearch init **** ");
	initSetRegion();
...
function uninit()
{
    console.log("***** satManualSearch uninit **** ");
