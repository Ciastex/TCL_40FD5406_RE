...
var preset_channel = ["Factory\\Preset Channel","Pre-Frequency HZ","Pre-Frequency Poland","Pre-Frequency NM","Pre-Frequency WX","Pre-Frequency ODM", "Pre-Frequency PKV", "Pre-Frequency MX", "Pre-Frequency RV", "Pre-Frequency SEMP", "Pre-Frequency FLB", "Pre-Frequency Newsan", "Pre-Frequency ODM_CB", "Pre-Frequency DIXON"];
var preset_channel_P1 = ["Factory\\Preset Channel","Pre-Frequency RU","Pre-Frequency RU-KVANT","Pre-Frequency CVT"];
...
var PRESET_MENU_ITEM_LENGHT = 13;
var PRESET_MENU_ITEM_LENGHT_P1 = 3;
...
function toUp()
{
	...
	else if(form_flag == 8)
	{
		if(pre_channel_position_h== 0)
		{
			...
			{
				preset_menu_page = 1;
				showPresetChannelMenu(PRESET_MENU_ITEM_LENGHT_P1,0,preset_menu_page);
				div_contain_list[PRESET_MENU_ITEM_LENGHT_P1].style.background = "#FF0";
				pre_channel_position_h = PRESET_MENU_ITEM_LENGHT_P1 - 1;
				
			}
			else if(preset_menu_page == 1)
			{	
				preset_menu_page = 0;
				showPresetChannelMenu(PRESET_MENU_ITEM_LENGHT,0,preset_menu_page);
...
function toDown()
{
	...
	else if(form_flag == 8)
	{
		...
		{
			if(pre_channel_position_h ==( PRESET_MENU_ITEM_LENGHT_P1 -1))
			{
				preset_menu_page = 0;			
				showPresetChannelMenu(PRESET_MENU_ITEM_LENGHT,0,preset_menu_page);
				div_contain_list[PRESET_MENU_ITEM_LENGHT_P1].style.background = "#FFF";
				div_contain_list[1].style.background = "#FF0";
				pre_channel_position_h = 0;
	...
	if(form_flag == 0)
	{
		switch(position_h)
		{
			...
			case 6:
				...
				div_contain_list[14].style.background = "#FFF";
				//初始化
				showPresetChannelMenu(PRESET_MENU_ITEM_LENGHT,1,0);
				form_flag = 8;
				break;
			case 8:
				//清除痕迹
...
function showPresetChannelMenu(item_lenght,menu_init,menu_page)
{
	if(menu_init == 1)
	{
		preset_menu_page = 0;
	...
	for(var i = item_lenght; i < FACTORY_MENU_ITEM_LENGHT; i++)
	{
		span_contain_list[i].style.display = "none";
		div_contain_list[i + 1].style.display = "none";
	}

	for(var i = 0; i < item_lenght; i++)
	{
	...
	for(var i = 0; i <= item_lenght; i++)
	{
		...
		{
			div_contain_list[i].innerHTML = preset_channel_P1[i];
		}
	}
