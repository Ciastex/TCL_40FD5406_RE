...
var sourceList =
[
	{name:top.sourceOptions[0],   id:"0",  icon:"images/TV.png?md5=49b59bfa2a1f52e3231f1c4aff710532",    icon_disable:"images/TV_disable.png?md5=9df64cd2aec7a0da1541a9a054d9fece"},
	{name:top.sourceOptions[0],   id:"1",  icon:"images/TV.png?md5=49b59bfa2a1f52e3231f1c4aff710532",    icon_disable:"images/TV_disable.png?md5=9df64cd2aec7a0da1541a9a054d9fece"},
	{name:top.sourceOptions[1],  id:"2",  icon:"images/av.png?md5=0f924d3575dd723c97956c5a314f70cf", icon_disable:"images/av_disable.png?md5=8834307fdf3fe516d69d503aa67cdf6c"},
	{name:top.sourceOptions[1],  id:"3",  icon:"images/av.png?md5=0f924d3575dd723c97956c5a314f70cf", icon_disable:"images/av_disable.png?md5=8834307fdf3fe516d69d503aa67cdf6c"},
	{name:top.sourceOptions[1],   id:"11", icon:"images/scart.png?md5=d05a8ed87122724d605fe333488d2140", icon_disable:"images/scart_disable.png?md5=6aefdc058936bc89488d47df03769542"},
	{name:top.sourceOptions[2],  id:"4",  icon:"images/cmp.png?md5=2f49834a2ff468b06579e0d01998f689", 	 icon_disable:"images/cmp_disable.png?md5=48de5dade54995011c1e358f43f79af5"},
	{name:top.sourceOptions[3],id:"6",  icon:"images/HDM1.png?md5=e61583c22ae5a0432c970d9fc18249c1",  icon_disable:"images/HDM1_disable.png?md5=9ee3f2f1ea7b6c85a3f62a03acacaa4a"},
	{name:top.sourceOptions[4],id:"7",  icon:"images/HDM1.png?md5=e61583c22ae5a0432c970d9fc18249c1",  icon_disable:"images/HDM1_disable.png?md5=9ee3f2f1ea7b6c85a3f62a03acacaa4a"},
	{name:top.sourceOptions[5],id:"8",  icon:"images/HDM1.png?md5=e61583c22ae5a0432c970d9fc18249c1",  icon_disable:"images/HDM1_disable.png?md5=9ee3f2f1ea7b6c85a3f62a03acacaa4a"},
	{name:top.sourceOptions[6],id:"12", icon:"images/HDM1.png?md5=e61583c22ae5a0432c970d9fc18249c1",  icon_disable:"images/HDM1_disable.png?md5=9ee3f2f1ea7b6c85a3f62a03acacaa4a"},
	{name:top.sourceOptions[8]?top.sourceOptions[8]:"Media",id:"10", icon:"images/USB.png?md5=f46491811162abaf76b1f90a26f69d59",   icon_disable:"images/USB_disable.png?md5=a961e3b11f2c7eb403083402bfaa9020"},
    {name:top.sourceOptions[7],id:"5", icon:"images/VGA.png?md5=13047b164c61861c7fa5cb12f84b4b9e",   icon_disable:"images/VGA_disable.png?md5=e79812d676f4beeeaa6de3ff9cddde09"},
];
...
function init()
{
	...
	for(var i = 0 ;i<currSourceList.length;i++)
	{
		...
		tvPageFocusDivs[i+1].getElementsByTagName("span")[0].innerHTML = ""+source.getName();
        var downPosition;
            if(i==0) 
            	downPosition = 2;
            else
...
function getSources()
{
    ...
    if((top.supportATVSource == 1) || (top.supportDTVSource == 1)||(setting.getProperty("ro.sita.model.LiveTV.TV","FALSE") == "TRUE"))
    {
