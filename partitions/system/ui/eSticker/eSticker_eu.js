...
var xmlImg_D = new Array(); //img数组，存储xml文件中所用img_D标签的值
...
function initData()
{
    ...
    {
        $("estickBackground").src = "../images/esticker/esticker_new_bg.png";
        $("mainDivImg").src = "../images/esticker/esticker_new_bg_info_l.png";
    }
    else
    {
        $("estickBackground").src = "../images/esticker/esticker_new_bg_tcl.png";
        $("mainDivImg").src = "../images/esticker/esticker_new_bg_info_l_tcl.png";
    }
    ...
    $("contentImgId").src = iconImgArrayS[0];

    $("icon6_2").getElementsByTagName("img")[0].src = iconStaticImgArray[0];//品牌图片
...
function test()
{
    ...
    setTimeout(function ()
    {
        ...
        $("contentImgId").src = iconImgArrayD[icon_position];
...
function getImg_D()
{
    ...
    for (var i = 0; i < icons.length; i++)
    {
        img_D = icons[i].getElementsByTagName("img_D");
        if (img_D[0] != undefined)
            xmlImg_D.push(img_D[0].childNodes[0].nodeValue);
        else
            xmlImg_D.push("***");
        //top.g_channel.testLog(xmlImg_L[i]);
    }
