...
function loadHistroy(backInfo)//加载历史数据
{
    ...
    while (backInfo.historyItem[NumofHistory] != undefined)
    {
        ...
        if (NumofHistory == 0 || sameDayJudge == false)//判断是否新起一行
        {
            ...
            img.setAttribute("src", "../images/TimelinePoint.png?md5=dcb7f79cf5c83901d981803f4f5f9111");
        ...
        divReal.style.backgroundImage = 'url(../images/video-Default.png?md5=6ca6fb51722a4c79f613dcdbe20cf9c5)';
        ...
        img.setAttribute("src", "../images/delete.png?md5=9f6af6b2ccc652fb834b788f646c6774");
        ...
        /*  img = document.createElement("img");//进度条背景
         ...
         img.setAttribute("src", "../images/progressbarBackground.png?md5=36c51d7129a7320f721ce5c608adb0d2");
         itemDiv.appendChild(img);

         img = document.createElement("img");//进度条
         img.setAttribute("id", "progressBar");
         img.setAttribute("src", "../images/progressbar.png?md5=6f2a9f2caa1b9117f8af4aad0d402b61");
         itemDiv.appendChild(img);
...
function enterResponse()//响应ok键
{
    ...
    else// choose state
    {
        ...
        if (DelID == "delALL")
        {
            delAllData(1);
            var Option = document.getElementById(DelID);
            Option.style.backgroundImage = "url('../images/unCheckedButton.png?md5=01a81ce104f0ceeba71f744e300a8fe9')";
...
function initNotice()
{
	...
	//$("buttonImg").src = '../images/icon-setting.png?md5=21a0511b83a13b13d01091e5d703d42d';  
