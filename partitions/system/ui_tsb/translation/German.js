...
var all_country 	= ["Australien","Österreich","Belgien","Bulgarien","Kroatien","Tschechien","Dänemark","Finnland","Frankreich","Deutschland",
						...
						"Moldawien"," "," "," "," "," "," "," ","Ghana"," ",
						" "," "," "," "," "," ","Morocco"," "," "," ",
						" "," "," "," "," "," "," ","Albanien","Belarus","Iceland",
						"Litauen","","","","","","Bosnien und Herzegowina","Zypern","Kosovo","Mazedonien",
...
var sysOptions		= ["eBedienungsanleitung","Menü-Sprache","Timer","Sperren","Einstellung für Eingänge",
						...
						"Experten-Einstellungen","Werkseinst. wiederherstellen","LED-Anzeige","Soforteinschaltung","Auto shop mode","Area","Demo-Modus"];
...
var picOptions		= ["Bildvoreinstellung",
						...
						"Experten-Einstellungen","Bild zurücksetzen"];
...
var smartTVOptions		= ["Portal für Smart TV","HbbTV","Share & See","WLAN-Anzeige","Richtlinien für Smart TV",
    "Vernetztes Standby","smart TV zurücksetzen"];
...
var eStickerTipWords = ["Weniger als 500M Speicherplatz vorhanden; Videos im Demo-Modus löschen, um Speicherplatz freizusetzen?"];
