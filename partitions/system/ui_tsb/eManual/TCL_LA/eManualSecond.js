...
var tvImageArrayImgName = ["screen-launcher.png",//0
						   "screen-source.png",
						   "screen-foxxum.png",
						   "screen_usb.png",
						   "screen-remote.png",
						   ...
						   "screen-picture.png",//10
						   "screen-sound.png",
						   "screen-channel.png",
						   "screen-update.png",
						   "screen-language.png",
						   "screen-parentLock.png",//15
							"screen-StatusBar.png",
							"screen-foxxum.png"];
...
var contentSpan1_8Array = top.contentSpan1_8Array;
...
var contentSpan1_10Note = top.remoteControlNote;

var tcastWords = top.tcastOtherWords;
/***
...
function setLATextImage()
{
	...
	if(language == "English")
	{
		$("contentSpan1-1-9").innerHTML = "CH"+contentSpan1_1Array[0][8]+ " "+contentSpan1_1Array[1][8];
	}
}
function init()
{
	...
	switch(page)
	{
		case 0:
		{
			...
			**/
			for(var i=0;i<5;i++)
			{
				...
				/*if(i > 2 )//Easy Navigation/TV Connection/Wireless
                {
                    $("contentSpan1-"+(i+1)+"Title").innerHTML = titleSpanSecondArray[0][i-1];
                }
                else if(0<i && i<3)//Panel Keys
                {
                    $("contentSpan1-"+(i+1)+"Title").innerHTML = titleSpanSecondArray[0][1];
                }
                else//Remote Control
				{
                    $("contentSpan1-"+(i+1)+"Title").innerHTML = titleSpanSecondArray[0][0];
                }*/
				if (i > 0)
				{
                    $("contentSpan1-"+(i+1)+"Title").innerHTML = titleSpanSecondArray[0][i+2];
				}
                else//Remote Control
                {
                    $("contentSpan1-"+(i+1)+"Title").innerHTML = titleSpanSecondArray[0][0];
			...
			$("contentSpan1-1-10").innerHTML = contentSpan1_10Note;

            // $("contentSpan1-3-1").innerHTML = contentSpan1_8Array[0]+ " (" + contentSpan1_8Array[4] + ")";
            // $("contentSpan1-3-2").innerHTML = contentSpan1_8Array[1];
            // $("contentSpan1-3-3").innerHTML = contentSpan1_8Array[4] + " " + contentSpan1_8Array[2];
            // $("contentSpan1-3-4").innerHTML = contentSpan1_8Array[4] + " " + contentSpan1_8Array[3];
			...
			// for(var i=0;i<5;i++)
			// {
			// 	$("contentSpan1-4-"+(i+1)).innerHTML = contentSpan1_3Array[i];
			// }
			// $("contentSpan1-4-6").innerHTML = "* "+ contentSpan1_3Array[5];

			for(var i=0;i<10;i++)
			{
				$("contentSpan1-2-"+(i+1)).innerHTML = contentSpan1_4Array[i];
			}
			$("contentSpan1-2-11").innerHTML = "* "+contentSpan1_4Array[10];

			for(var i=0;i<13;i++)
			{
				$("contentSpan1-3-"+(i+1)).innerHTML = contentSpan1_5Array[i];
			}
			$("contentSpan1-3-14").innerHTML = "* "+contentSpan1_5Array[13];

			for(var i=0;i<11;i++)
			{
				$("contentSpan1-4-"+(i+1)).innerHTML = contentSpan1_6Array[i];
			}
			$("contentSpan1-4-12").innerHTML = "* "+contentSpan1_6Array[11];
            
            
            for(var i=0;i<5;i++)
			{
				$("contentSpan1-5-"+(i+1)).innerHTML = contentSpan1_7Array[i];
            }

			$("contentDiv1-1Img").src = "../../images/emanual/remoteControl_LA_2.png";
            // $("contentDiv1-2Img").src = "../../images/emanual/panel_keys.png";
            // $("contentDiv1-3Img").src = "../../images/emanual/panel_keys2.png";
            // $("contentDiv1-4Img").src = "../../images/emanual/TV_control.png";
            $("contentDiv1-2Img").src = "../../images/emanual/TV_connections1.png";
            $("contentDiv1-3Img").src = "../../images/emanual/TV_connections2.png";
            $("contentDiv1-4Img").src = "../../images/emanual/TV_connections3.png";
            $("contentDiv1-5Img").src = "../../images/emanual/wireless.png";
			setLATextImage();
		}
		break;
		case 1:
		...
		case 2:
		{
			...
			**/
			...
			{
				if (i == 2)
                    $("contentSpan3-3Title").innerHTML = tcastWords[3];
				else
			...
			$("contentSpan3-3-2").innerHTML = contentSpan3Array[4];
			$("contentSpan3-3-3").style.display = "none";

			$("contentDiv3-1-1Img").src = "../../images/emanual/TV.png";
  			if(top.g_setting.manufacturer =="JVC")
			{
                $("contentDiv3-1-2Img").src ="../../images/emanual/screen-opera_dump_JVC.png";
            }
			else
			{
                if(top.isAUFlag)
				{
                    ...
                    $("contentDiv3-1-2Img").src = tvImageArray[17];
				}
                else
				{
			...
			$("contentDiv3-3-5Img").style.display = "none";
		}
		break;
		case 3:
		{
