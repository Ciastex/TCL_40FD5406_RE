...
var usb_update = ["ServiceMenu\\USB Update","Main Upgrade","MEMC Upgrade","HDCP Upgrade","Mboot Upgrade","CI+ KEY Upgrade","Nvm Upgrade","Nvm Backup","CH List Upgrade","CH List Backup","HDCP2.0 Upgrade"];
...
function doOk()
{
	...
	else if(form_flag == 3)
	{
		...
		{
			case 0:
                span_contain_list[form_position_h].innerHTML = other[1];
                if(0 == factory.usbUpdate(6))
                {
                    span_contain_list[form_position_h].innerHTML = other[2];
                }
                else
                {
                    span_contain_list[form_position_h].innerHTML = other[3];
                }
                break;
			case 1:
                span_contain_list[form_position_h].innerHTML = other[1];
                if(0 == factory.usbUpdate(0))
                {
                    span_contain_list[form_position_h].innerHTML = other[2];
                }
                else
...
function showFactory()
{
	...
	{
        span_contain_list[0].innerHTML = factoryInfo.swName+"."+top.configPackVersion;
	}
...
function showUsbUpdate()
{
	...
	span_contain_list[0].innerHTML = other[0];
	...
	span_contain_list[6].innerHTML = other[0];
	span_contain_list[7].innerHTML = other[0];
