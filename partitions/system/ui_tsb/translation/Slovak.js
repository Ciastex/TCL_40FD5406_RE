...
var all_country 	= ["Austrália","Rakúsko","Belgicko","Bulharsko","Chorvátsko","Česká republika","Dánsko","Fínsko","Francúzsko","Nemecko",
						...
						"Moldavsko"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albánsko","Belarus","Iceland",
						"Litva","","","","","","Bosna a Hercegovina","Cyprus","Kosovo","Macedónia",
						"Malta","Čierna Hora","Others"];
...
var sysOptions		= ["Elektronická príručka","Jazyk OSD","Nastavenie času","Zamknúť","Nastavenia vstupu",
						...
						"Rozšírené nastavenia","Reset shop","LED kontrolka","Okamžité zapnutie","Auto shop mode","Area","Režim ukážky"];
...
var picOptions		= ["Režim pre obraz",
						...
						"Rozšírené nastavenia","Vynulovanie obrazu"];
...
var smartTVOptions		= ["Portál Smart TV","HbbTV","Zdieľať a zobraziť","Wifi displej","Zásady Smart TV",
    "V sieti v pohotovostnom režime","Resetovať smart TV"];
...
var eStickerTipWords = ["Úložisko má menej ako 500 M, želáte si vymazať videá v režime Demo, aby ste získali viac priestoru?"];
