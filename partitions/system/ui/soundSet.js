...
var soundPresetModeWords 		= [top.souPreset[0], top.souPreset[1], top.souPreset[2],
    top.souPreset[3], top.resetStadium, top.picturePresetArray[1],top.souPreset[4]];
...
var PROGRESS_SPDIF_MAX_VALUE = 1000;//sPDIFDelay 的取值范围是0-PROGRESS_SPDIF_MAX_VALUE,最大值为PROGRESS_SPDIF_MAX_VALUE
var PROGRESS_AUDIO_MAX_VALUE = 1000;
var PROGRESS_MAX_VALUE = 100;

var PROGRESS_AUDIO_DELAY_MAX_VALUE = 1000;
