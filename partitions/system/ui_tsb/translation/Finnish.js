...
var all_country 	= ["Australia","Itävalta","Belgia","Bulgaria","Kroatia","Tšekki","Tanska","Suomi","Ranska","Saksa",
						...
						"Liettua","","","","","","Bosnia-Hertsegovina","Kypros","Kosovo","Makedonia",
...
var sysOptions		= ["E-manuaali","Näyttövalik. kieli","Ajastin","Lukitse","Syöttöasetukset",
						...
						"Lisäasetukset","Resetoi kauppa","LED-merkkivalo","Välitön virrankytkentä","Auto shop mode","Area","Demo-tila"];
...
var smartTVOptions		= ["Smart TV -portaali","HbbTV","Jaa & Katsele","Wi-FI-näyttö","Smart TV -käytäntö",
    "Verkotettu valmiustila","Nollaa smart TV"];
...
var contactUsOption = ["Yhteystiedot",
    ...
    "Софтуерна версия:","","Käyttäjätunnus:","Projektitunnus:",
...
var eStickerTipWords = ["Muistitila on alle 500 M. Haluaisitko poistaa videoita demotilassa saadaksesi lisää tilaa?"];
