...
var all_country 	= ["Austraalia","Austria","Belgia","Bulgaaria","Horvaatia","Tšehhi Vabariik","Taani","Soome","Prantsusmaa","Saksamaa",
						...
						"Moldova"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albaania","Belarus","Iceland",
						"Leedu","","","","","","Bosnia ja Hertsegoviina","Küpros","Kosovo","Makedoonia",
...
var sysOptions		= ["E-kasutusjuhend","Menüü keel","Taimer","Lukusta","Sisendi seaded",
						...
						"Täpsemad seaded","Taasta tegevus","LED indikaator","Kohene sisselülitamine","Auto shop mode","Area","Demorežiim"];
...
var picOptions		= ["Pildi eelmääramine",
						...
						"Täpsemad seaded","Pildi lähtestus"];
...
var smartTVOptions		= ["Smart TV portaal","HbbTV","Jaga & Vaata","Wifi ekraan","Smart TV poliitika",
    "Võrk ooterežiimis","Lähtesta smart TV"];
...
var eStickerTipWords = ["Salve mahtuvus on alla 500 M, kas soovite esitlusrežiimi videod kustutada, et saada rohkem mälumahtu?"];
