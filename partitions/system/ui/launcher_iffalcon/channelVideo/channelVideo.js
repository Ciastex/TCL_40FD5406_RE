...
function createDiv(backInfo , startDiv , endDiv , pageNum)//加载数据
{
	...
	for (;startDiv <= endDiv;startDiv++)
	{
		...
		div.style.backgroundImage = 'url(../images/video-Default.png?md5=6ca6fb51722a4c79f613dcdbe20cf9c5)';
...
function systemEventHandle(evt)
{
    ...
    switch (msg)
    {
		...
		case E_CEC_ARC_AUDIO_STATUS_CHANGE:
		case E_HP_PLUGIN:
		case E_HP_PLUGOUT:
            top.systemEventProc(evt);
            break;
...
{    
    ...
    console.log("------------------------------get hl and zone = "+top.getZone()+"---language = "+top.getLanguage());
...
{// loading图标
	var loadingImgs		= ["../images/Loading-01.png?md5=67cd62839e5eca44db31601e2cf987dd",
						   "../images/Loading-02.png?md5=d4c50bdef0d34a94fb033ef9f930a46e",
						   "../images/Loading-03.png?md5=cd93bdb87e2fa90ec6df47fc9cef1a86",
						   "../images/Loading-04.png?md5=deb084e74d1d0ed6a437327f31333c9c",
						   "../images/Loading-05.png?md5=3dcfc1b2cf37c139e14ab076f32c6bdf",
						   "../images/Loading-06.png?md5=ef683403de836879a06a63e93e2227e9",
						   "../images/Loading-07.png?md5=eaa504ccfab0a3f560c7a27ab28ec8b8",
						   "../images/Loading-08.png?md5=d05761431a1e67bffd4c25143379efc1"];
					...
					if( channelInfo.pageInfo.totalResults !=0)
					{
                        ...
                        if(channelFlag == 1)
                        {
                            if (channelKey!="Popular Right Now")
                            {
                                ...
                                channelUrl = "https://www.googleapis.com/youtube/v3/channelSections?part=snippet%2CcontentDetails&channelId="+channelId+"&key="+youtubeKey;
                            }
                            else
                            {
