...
var all_country 	= ["Australia","Østerrike","Belgia","Bulgaria","Kroatisk","Tsjekkia","Danmark","Finland","Frankrike","Tyskland",
						...
						"Moldova"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albansk","Belarus","Iceland",
						"Litauen","","","","","","Bosnia Hercegovina","Kypros","Kosovo","Makedonia",
...
var sysOptions		= ["Elektronisk bruksanvisning","OSD-språk","Tidsoppsett","Lås","Inngangsinnstillinger",
						...
						"Avanserte innstillinger","Fabrikkinnstillinger","LED-indikator","Umiddelbar påslåing","Auto shop mode","Area","Demomodus"];
...
var picOptions		= ["Bildemodus",
						...
						"Avanserte innstillinger","Bildenullstilling"];
...
var smartTVOptions		= ["Smart TV-portal","HbbTV","Del og se","Wifi-visning","Retningslinjer for Smart TV",
    "Nettverksstandby","Nullstill smart TV"];
...
var eStickerTipWords = ["Lagringsplassen er mindre enn 500 M, vil du slette videoene i Demo-modus for å få mer plass?"];
