...
var VirtualKeyboard = new function() {
    ...
    var d = function(i) {
        ...
        switch (il) {
            ...
            case "ctrl_right":
                ...
                break;
            default:
                if (_ && i.which == 13) DOM.CSS(e).addClass(y.buttonDown);
                break
        }
        if (X != iI) {
            B(iI);
    ...
    I.attachInput = function(i) {
        ...
        if (!i || !i.tagName) {
            ...
            EM.addEventListener(i, 'keyup', I.IME.blurHandler);
    ...
    I.detachInput = function() {
        ...
        if (U.attachedInput) {
            ...
            EM.removeEventListener(i, 'keyup', I.IME.blurHandler);
            var e = document.body.parentNode;
    ...
    var M = function(i) {
        ...
        for (var iI = 0, il = i.length, io = [], iO, iQ; iI < il; iI++) {
            iO = i[iI];
            io.push(["<div id='", Q, iI, "' class='", y.buttonUp, "'><a href='#' onkeydown='tim_imKeyDown(this)'>", ii(Y, iO, z, y.charNormal, e), ii(Y, iO, Z, y.charShift, e), ii(Y, iO, q, y.charAlt, e), ii(Y, iO, R, y.charShiftAlt, e), ii(Y, iO, s, y.charCaps, e), ii(Y, iO, t, y.charShiftCaps, e), "</a></div>"].join(""));
        }
        for (var iI in C) {
            if (C.hasOwnProperty(iI)) {
                iO = C[iI];
                iQ = iO.replace(/_.+/, '');
                io.splice(iI, 0, ["<div id='", Q, iO, "' class='", y.buttonUp, "'><a href='#' onkeydown='tim_imKeyDown(this)' title='", iQ, "'", "><span class='title'>", iQ, "</span>", "</a></div>"].join(""));
            }
        }
    ...
    (function() {
        ...
        EM.addEventListener(U.desk, 'keydown', d);
        EM.addEventListener(U.desk, 'keyup', A);
        EM.addEventListener(U.desk, 'focus', D);
        EM.addEventListener(U.desk, 'blur', D);
...
VirtualKeyboard.IME = new function() {
    var i = this;
    var I = "<div id=\"tim_VirtualKeyboardIME\"><table><tr><td class=\"IMEControl\"><a href='#' class=\"tim_left\"><!-- --></a></td>" + "<td class=\"IMEControl IMEContent\"></td>" + "<td class=\"IMEControl\"><a href='#' class=\"tim_right\"><!-- --></a></td></tr>" + "<tr><td class=\"IMEControl IMEInfo\" colspan=\"3\"><div class=\"showAll\"><div class=\"IMEPageCounter\"></div><a href='#' class=\"arrow\"></a></div></td></tr></div>";
    var l = null;
    var o = "";
    var O = 0;
    var Q = false;
    ...
    i.nextPage = function(x) {
      ...
      if(x.which == 37) {
		  var temp = this.previousSibling.firstChild.firstChild.firstChild.firstChild;
    ...
    i.prevPage = function(x) {
		...
		if(x.which == 39) {
		  this.nextSibling.firstChild.firstChild.firstChild.firstChild.firstChild.focus();
		  return true;
	  }	
    };
    i.getPage = function() {
        ...
        for (var X = 0, z = Math.ceil(_.length / 10); X < z; X++) {
            if (Q || X == O) {
                ...
                for (var Z = 0, w = X * 10; Z < 10 && !isUndefined(_[w + Z]); Z++) {
                    x.push("<td><a href='' onkeydown='tim_imKeyDown(this)'>");
                    if (X == O) {
                        x.push("<b>&nbsp;" + ((Z + 1) % 10) + ": </b>");
                    } else {
                        x.push("<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>");
    ...
    var V = function() {
        ...
        EM.addEventListener(X, 'keydown', i.prevPage);
        EM.addEventListener(X, 'keydown', EM.preventDefaultAction);
        EM.addEventListener(X, 'keydown', EM.stopPropagationAction);
        EM.addEventListener(z, 'keydown', i.nextPage);
        EM.addEventListener(z, 'keydown', EM.preventDefaultAction);
        EM.addEventListener(z, 'keydown', EM.stopPropagationAction);
        EM.addEventListener(Z, 'keydown', i.toggleShowAll);
        EM.addEventListener(Z, 'keydown', EM.preventDefaultAction);
        EM.addEventListener(Z, 'keydown', EM.stopPropagationAction);
        l.unselectable = "on";
        var w = l.getElementsByTagName("*");
        ...
        EM.addEventListener(l, 'keydown', v);
        EM.addEventListener(l, 'keyup', EM.preventDefaultAction);
