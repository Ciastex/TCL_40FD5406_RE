...
var all_country 	= ["Österrike","Österrike","Belgien","Bulgarien","Kroatien","Tjeckien","Danmark","Finland","Frankrike","Tyskland",
						...
						"Litauen","","","","","","Bosnien Hercegovina","Cypern","Kosovo","Makedonien",
...
var sysOptions		= ["E-Manual","OSD-språk","Tidsinställning","Lås","Inmatningsinställningar",
						...
						"Avancerade inställningar","Återställ","LED-indikator","Direkt ström på","Auto shop mode","Area","Demo-läge"];
...
var picOptions		= ["Bildläge",
						...
						"Avancerade inställningar","Bildåterställning"];
...
var smartTVOptions		= ["Smart TV-portal","HbbTV","Dela & se","WiFi-visning","Smart TV-policy",
    "Nätverk i standby","Återställ smart-TV"];
...
var eStickerTipWords = ["Lagringsutrymmer är under 500M, vill du radera videoklippen i Demo-läget för att få mer utrymme?"];
