...
var all_country 	= ["Australia","Austria","Belgio","Bulgaria","Croazia","Repubblica Ceca","Danimarca","Finlandia","Francia","Germania",
						...
						"Lituania","","","","","","Bosnia ed Erzegovina","Cipro","Kosovo","Macedonia",
						"Malta","Montenegro","Others","Mali"];
...
var sysOptions		= ["Manuale elettronico","Lingua menu","Temporizzatore","Blocca","Impostaz. Ingresso",
						...
						"Impostazioni avanzate","Azzera negozio","Indicatore LED","Accensione istantanea","Auto shop mode","Area","Modalità Demo"];
...
var picOptions		= ["Modalità Immagine",
						...
						"Impostazioni avanzate","Reimposta immagine"];
...
var smartTVOptions		= ["Portale Smart TV","HbbTV","Share & see","Visualizzazione Wi-Fi","Linee guida Smart TV",
    "Standby di rete","Reimposta smart TV"];
...
var tcastOtherWords = ["Nuskenuokite QR kodą ir atsisiųskite T-Cast","Tinklas prijungtas prie TV","TV pavadinimas","T-Cast"];
...
var eStickerTipWords = ["Lo spazio disponibile è inferiore ai 500 MB. Eliminare i video in modalità Demo per ottenere più spazio?"];
