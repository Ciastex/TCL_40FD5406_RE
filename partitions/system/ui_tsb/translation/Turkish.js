...
var all_country 	= ["Avustralya","Avusturya","Belçika","Bulgaristan","Hırvatistan","Çek Cumhuriyeti","Danimarka","Finlandiya","Fransa","Almanya",
						...
						"Moldova"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Arnavutluk","Belarus","Iceland",
						"Litvanya","","","","","","Bosna Hersek","Kıbrıs","Kosova","Makedonya",
						"Malta","Karadağ","Others"];
...
var sysOptions		= ["E-Kılavuz","Menü dili","Zamanlayıcı","Kilitle","Giriş Ayarları",
						...
						"Gelişmiş ayarlar","Alışverişi sıfırla","LED Gösterge","Hızlı açma","Auto shop mode","Area","Demo Modu"];
...
var picOptions		= ["Resim önayarı ",
						...
						"Gelişmiş ayarlar","Resim sıfırlama"];
...
var smartTVOptions		= ["Smart TV portalı","HbbTV","Paylaş ve Gör","Wifi ekranı","Smart TV politikası",
    "Ağ tabanlı bekleme","smart TV’yi sıfırla"];
...
var eStickerTipWords = ["Depolama birimi boyutu 500 M’nin altında, Daha fazla alan elde etmek için Demo modundaki videoları silmek ister misiniz?"];
