...
var all_country 	= ["Australia","Austria","Belgia","Bułgaria","Chorwacja","Czechy","Dania","Finlandia","Francja","Niemcy",
						...
						"Mołdawia"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albania","Belarus","Iceland",
						"Litwa","","","","","","Bośnia i Hercegowina","Cypr","Kosowo","Macedonia",
						"Malta","Czarnogóra","Others"];
...
var sysOptions		= ["E-instrukcja","Język OSD","Ust. czasu","Blokada","Ustawienia sygn. wej.",
						...
						"Ustawienia zaawansowane","Zreset. sklep","Wskaźnik LED","Natychmiastowe włączenie","Auto shop mode","Area","Tryb Demo"];
...
var picSize			= ["16:09", "Format 4:3 ", "Format 14:9", "Cinerama",
						"Zoomen 16:9", "Uitzoomen 16:9","Zoomen 14:9","Uitgerekte zoom","Brede zoom",
						"Uitzoomen 2","Brede zoom 2","Rozdzielczość natywna","Punt voor punt","Oryginał","Panorama"];
...
var smartTVOptions		= ["Portal Smart TV","HbbTV","Podziel się i oglądaj","Wyświetlacz Wi-Fi","Polityka Smart TV",
    "Połączony w sieci tryb czuwania","Resetuj smart TV"];
...
var eStickerTipWords = ["Pozostało poniżej 500M miejsca w pamięci zewnętrznej. Wykasować filmy trybu Demo, aby uzyskać więcej miejsca?"];
