...
function keyHandle(evt)
{
	...
	case VK_CAREVISION:	
        ...
        case VK_PANEL_OK:
		case VK_PANEL3_DOWN://�����������-,��������壩
		case VK_PANEL3_UP://������Ҳ����+,��������壩
		case VK_PANEL3_OK://�����˵���,��������壩
		case VK_PANEL3_LONG_OK://�������˵�����������壩
        case VK_PANEL_LEFT:
        case VK_PANEL_RIGHT:
        case VK_PANEL_DOWN:
        case VK_PANEL_UP:
...
function showTeamSchedule(data)
{
    ...
    if (data)
    {
        ...
        for (var i=0; i<data.length; i++)
        {
            ...
            {
                vs.innerHTML = "";
                vs.style.backgroundImage = "url(images/line.png?md5=f987660ebf61599e6d93e36946cc950e)";
            }
            else
            {
                vs.innerHTML = "VS";
    ...
    if (data)
    {
        ...
        for (var i=0; i<times.length; i++)
        {
            if (i<data.length)
            {
                ...
                {
                    team1icons[i].src = "images/team_bg.png?md5=6bd5658d0a099449e17bee9401588be6";
                }
                else
                {
                ...
                {
                    team2icons[i].src = "images/team_bg.png?md5=6bd5658d0a099449e17bee9401588be6";
                }
                else
                {
                ...
                {
                    vss[i].innerHTML = "";
                    vss[i].style.backgroundImage = "url(images/line.png?md5=f987660ebf61599e6d93e36946cc950e)";
                }
                else
                {
                    vss[i].innerHTML = "VS";
...
function showFinal(data)
{
    ...
    for (var i=0; i<finalteama.length&&j<data.length; i++)
    {
        ...
        finalteama[i].getElementsByTagName("img")[0].src = played?data[j].team1png:"images/global_2.png?md5=688b0d9fcf9de6d5d9a2b477b7f6710d";
        ...
        finalteama[i].getElementsByTagName("img")[0].src = played?data[j].team2png:"images/global_2.png?md5=688b0d9fcf9de6d5d9a2b477b7f6710d";
        j++;
    }
    ...
    for (var i=0; i<finalteama.length&&j<data.length; i++)
    {
        ...
        finalteama[i].getElementsByTagName("div")[0].innerHTML = played?data[j].team1:"";
        finalteama[i].getElementsByTagName("img")[0].src = played?data[j].team1png:"images/global_1.png?md5=0d86fabcd91b4677932703738314a47f";
        scores[i/2].innerHTML = data[j].team1score?(data[j].team1score+":"+data[j].team2score):"";
        i++;
        played = 1;
        if (data[j].team2png.indexOf("Default.png")!=-1 || data[j].team2png.indexOf("Y_placeholder_70x70.png")!=-1)
        ...
        finalteama[i].getElementsByTagName("div")[0].innerHTML = played?data[j].team2:"";
        finalteama[i].getElementsByTagName("img")[0].src = played?data[j].team2png:"images/global_1.png?md5=0d86fabcd91b4677932703738314a47f";
        j++;
    }
    finalteama = document.getElementsByClassName("finalteamx");
    var winner = 1;
    if (data[data.length-1].winner==data[data.length-1].team2)
    {
        winner = 2;
    }
    scores[scores.length-1].innerHTML = data[data.length-1].team1score?(data[data.length-1].team1score+":"+data[data.length-1].team2score):"";
    finalteama[0].getElementsByTagName("div")[0].innerHTML = data[data.length-1].team1score?((winner==1)?data[data.length-1].team1:data[data.length-1].team2):"";
    finalteama[0].getElementsByTagName("img")[0].src = data[data.length-1].team1score?((winner==1)?data[data.length-1].team1png:data[data.length-1].team2png):"images/global.png?md5=1deb24745387e963216d871c5f24e5b1";
}
