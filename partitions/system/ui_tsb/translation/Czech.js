...
var all_country 	= ["Austrálie","Rakousko","Belgie","Bulharsko","Chorvatsko","Česká republika","Dánsko","Finsko","Francie","Německo",
						...
						"Moldavsko"," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," "," "," "," ",
						" "," "," "," "," "," "," ","Albánie","Belarus","Iceland",
						"Litva","","","","","","Bosna a Hercegovina","Kypr","Kosovo","Makedonie",
						"Malta","Černá Hora","Others"];
...
var sysOptions		= ["Elektronická příručka","Jazyk OSD","Nastavení času","Zamknout","Nastavení vstupů",
						...
						"Upřesňující nastavení","Reset shop","LED indikátor","Okamžité zapnutí","Auto shop mode","Area","Režim Demo"];
...
var picOptions		= ["Režim obrazu",
						...
						"Upřesňující nastavení","Resetovat obraz"];
...
var smartTVOptions		= ["Portál Smart TV","HbbTV","Prohlížení obsahu a jeho sdílení","Zobrazení Wi-Fi","Zásady portálu Smart TV",
    "Síťový pohotovostní režim","Resetovat funkci smart TV"];
...
var eStickerTipWords = ["K dispozici je méně než 500 MB místa. Chcete získat více místa odstraněním videí v režimu Demo?"];
