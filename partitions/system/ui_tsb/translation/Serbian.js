...
var all_country 	= ["Australija ","Austrija","Belgija","Bugarska","Hrvatska","Češka republika","Danska","Finska","Francuska","Nemačka",
						...
						"Litvanija","","","","","","Bosna i Hercegovina","Kipar","Kosovo","Makedonija",
						"Malta","Crna Gora","Others"];
...
var sysOptions		= ["E - priručnik","Jezik menija","Tajmer","Zaključaj","Postavke unosa",
						...
						"Напредна подешавања","Reset shop","LED indikator","Instant uključivanje","Auto shop mode","Area","Demo režim"];
...
var picOptions		= ["Unpared definisana slika",
						...
						"Напредна подешавања","Ponovno podešavanje slike"];
...
var smartTVOptions		= ["Portal Smart TV","HbbTV","Share & See","Prikaz Wi-Fi mreže","Smernice za Smart TV",
    "na mreži u pripravnosti","Resetovanje smart TV-a"];
...
var eStickerTipWords = ["Imate manje od 500 M memorije. Želite li da izbrišete video-snimke u Demo-režimu i oslobodite prostor?"];
