top.keySetForUI(1);
//change "Reset ALL" to "NVM Reset" in every region
...
var init_title = ["Main\\Factory","1--Factory hotkey","2--WARM UP","3--Reset Shop","4--White balance","5--Other","6--NVM Reset","7--Preset Factory Channel","8--Power on mode","9--USB Clone && Update","0--DeviceID test","SW NO:","Project Name:","SIACP Version:","Date:"];
var off_on = ["Off","On"];
...
var balance_color_temp = ["Cold","Stantard","Warm"];
...
var other_menu = ["Factory\\Other Menu","WatchDog","Project ID","Grey Ctrl","Update CI+ Credential","IPTV","Motion clarity","NETFIX ESN","CI+Key", "Reset ALL"];
...
var preset_channel_title = "Factory\\Preset Channel";
var preset_channel = ["Pre-Frequency HZ", "Pre-Frequency Poland", "Pre-Frequency NM", "Pre-Frequency WX", "Pre-Frequency ODM", "Pre-Frequency PKV", "Pre-Frequency MX", "Pre-Frequency RV", "Pre-Frequency SEMP", "Pre-Frequency FLB",
    "Pre-Frequency Newsan", "Pre-Frequency ODM_CB", "Pre-Frequency DIXON", "Pre-Frequency ODM_SOLNIK", "Pre-Frequency RU", "Pre-Frequency RU_KVANT","Pre-Frequency RU_TELEBALT","Pre-Frequency TH","Pre-Frequency ORION",
    "Pre-Frequency Default","Pre-Frequency ALGERIA", "Pre-Frequency YN", "Pre-Frequency INDIA", "Pre-Frequency IN", "Pre-Frequency CVT", "Pre-Frequency TUNISIA", "Pre-Frequency EG", "Pre-Frequency UZB", "Pre-Frequency JAC",
    "Pre-Frequency PAKISTAN", "Pre-Frequency BENNE", "Pre-Frequency ARABY", "Pre-Frequency ELTHOLATHIA", "Pre-Frequency CONDOR", "Pre-Frequency UPAC", "Pre-Frequency DG", "Pre-Frequency SZ", "Pre-Frequency TOT",
    "Pre-Frequency RSA", "Pre-Frequency ELECTROFUEGUINA", "Pre-Frequency PANASONIC", "Pre-Frequency IRAN", "Pre-Frequency TIRUPATI", "Pre-Frequency PANAMEX", "Pre-Frequency ONIDA"];
var iptv_menu = ["Factory\\Other\\IPTV","Update MAC address","Client Type"];
var mac_menu = ["Factory\\Other\\IPTV\\MAC","Update From USB","ESN Key status","MAC Address","PC Link Check"];
var usb_update = ["Factory\\USB Update","Main Upgrade","FRC Upgrade","FRC Backup","USB TO TV"," TV TO USB","ESN Key Upgrade","HDCP2.0 Upgrade","HDCP Upgrade", "WideVine Upgrade", "Device id Upgrade"];
...
var USB_UPDATE_ITEM_LENGHT = 10; //8;
var OTHER_MENU_ITEM_LENGHT = 9; //8;
var PROJECT_ID_ITEM_LENGHT = 7;
var KEY_MENU_ITEM_LENGHT = 3;
var PICTURE_MENU_ITEM_LENGHT = 12;
var Light_Sensor_LENGTH= 3;
var PRESET_MENU_ITEM_LENGHT = preset_channel.length;
var IPTV_MENU_ITEM_LENGHT = 2;
var MAC_ADDR_MENU_ITEM_LENGHT = 4;
var ADD_RESET_ALL_IN_OTHER_MENU = 1;
var IDX_OTHER_RESET_ALL = 8;
...
var preset_menu_page = 0;
var preset_channel_max_page = 0;
var current_page_item_length = 14;
						...
						if(warn_yes==1)
						{
							...
							switch(form_position_h)
							{
								...
								case 3:
									...
									{
										if(0 == factory.factoryAllDataClone())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&7";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&7";
                                        }
									}
									else if(clone_select_u2t == 1)
									{
                                        if(0 == factory.factoryChlClone())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&9";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&9";
                                        }
									}
									else if(clone_select_u2t == 2)
									{
                                        if(0 == factory.factoryUserDataClone())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&13";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&13";
                                        }
									}
									break;
								case 4:
									...
									{
                                        if(0 == factory.factoryAllDataCopy())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&8";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&8";
                                        }
									}
									else if(clone_select_t2u == 1)
									{
                                        if(0 == factory.factoryChlCopy())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&10";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&10";
                                        }
									}
									else if(clone_select_t2u == 2)
									{
                                        if(0 == factory.factoryUserDataCopy())
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdate&14";
                                        }
                                        else
                                        {
                                            top.$('otherPage').src = "factory/factoryPromptDialog.html?usbUpdateFail&14";
                                        }
									}
									break;
								case 5:
									if(factory.usbUpdate(3) == 0)
									    span_contain_list[5].innerHTML = "OK";
									else
									    span_contain_list[5].innerHTML = "failed";
									break;
                                case 6:
                                    if(factory.usbUpdate(15) == 0)
                                        span_contain_list[6].innerHTML = "OK";
                                    else
                                        span_contain_list[6].innerHTML = "failed";
                                    break;
                                case 7:
                                    if(factory.usbUpdate(4) == 0)
                                        span_contain_list[7].innerHTML = "OK";
                                    else
                                        span_contain_list[7].innerHTML = "failed";
                                    break;
                                case 8:
                                    if(factory.usbUpdate(17) == 0)
                                        span_contain_list[8].innerHTML = "OK";
                                    else
                                        span_contain_list[8].innerHTML = "failed";
                                    break;
                                case 9:
                                    if(factory.usbUpdate(18) == 0)
                                        span_contain_list[9].innerHTML = "OK";
                                    else
                                        span_contain_list[9].innerHTML = "failed";
                                    break;
								default:
									break;
							}
...
function notifyProcess(evt)
{
	...
	switch(msg)
	{
        ...
        case top.E_FACTORY_SET_PICTURE_MODE:
...
function doMenu()
{
	...
	else if(form_flag == 7)
	{
        ...
        for (var i = current_page_item_length; i < FACTORY_MENU_ITEM_LENGHT; i++) {
            {
                div_contain_list[i + 1].style.display = "block";
                span_contain_list[i].style.display = "block";
            }
	...
	else if(form_flag == 3)
	{
		switch(form_position_h)
		{
			...
			case 5:
				...
				break
			case IDX_OTHER_RESET_ALL:
				if (ADD_RESET_ALL_IN_OTHER_MENU == 1)
				{
					doResetAll();
				}
				break;
		...
		if(preset_menu_page == 0)
		{
			switch(pre_channel_position_h)
			{
				...
				case 4:
					...
					setTimeout(function(){
					factory.presetFactoryChannel = 6;
				...
				case 5:
					span_contain_list[5].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 14;
					span_contain_list[5].innerHTML = ">";
					},500);
					break;
				case 6:
					span_contain_list[6].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 15;
					span_contain_list[6].innerHTML = ">";
					},500);
					break;
				case 7:
					span_contain_list[7].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 16;
				...
				case 8:
					span_contain_list[8].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 17;
				...
				case 9:
					span_contain_list[9].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 9;
					span_contain_list[9].innerHTML = ">";
					},500);
					break;
				case 10:
					span_contain_list[10].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 19;
					span_contain_list[10].innerHTML = ">";
					},500);
					break;
				case 11:
					span_contain_list[11].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 20;
					span_contain_list[11].innerHTML = ">";
					},500);
					break;
				case 12:
					span_contain_list[12].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 22;
					span_contain_list[12].innerHTML = ">";
					},500);
					break;
				case 13:
					span_contain_list[13].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 23;
					span_contain_list[13].innerHTML = ">";
					},500);
					break;
				default:
					return;
		...
		else if(preset_menu_page == 1)
		{
			switch(pre_channel_position_h)
			{
				case 0:
					span_contain_list[0].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 11;
					span_contain_list[0].innerHTML = ">";
					},500);
					break;
				case 1:
					span_contain_list[1].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 25;
					span_contain_list[1].innerHTML = ">";
					},500);
					break;
                case 2:
                    span_contain_list[2].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 26;
                        span_contain_list[2].innerHTML = ">";
                    },500);
                    break;
                case 3:
                    span_contain_list[3].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 8;
                        span_contain_list[3].innerHTML = ">";
                    },500);
                    break;
				case 4:
                    span_contain_list[4].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 38;
                        span_contain_list[4].innerHTML = ">";
                    },500);
					break;
				case 5:
                    span_contain_list[5].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 4;
                        span_contain_list[5].innerHTML = ">";
                    },500);
					break;
				case 6:
                    span_contain_list[6].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 5;
                        span_contain_list[6].innerHTML = ">";
                    },500);
					break;
				case 7:
                    span_contain_list[7].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 7;
                        span_contain_list[7].innerHTML = ">";
                    },500);
					break;
				case 8:
                    span_contain_list[8].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 18;
                        span_contain_list[8].innerHTML = ">";
                    },500);
					break;
				case 9:
                    span_contain_list[9].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 10;
                        span_contain_list[9].innerHTML = ">";
                    },500);
					break;
				case 10:
                    span_contain_list[10].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 12;
                        span_contain_list[10].innerHTML = ">";
                    },500);
					break;
				case 11:
                    span_contain_list[11].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 13;
                        span_contain_list[11].innerHTML = ">";
                    },500);
					break;
				case 12:
                    span_contain_list[12].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 21;
                        span_contain_list[12].innerHTML = ">";
                    },500);
					break;
				case 13:
                    span_contain_list[13].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 24;
                        span_contain_list[13].innerHTML = ">";
                    },500);
					break;
				default:
		...
		else if(preset_menu_page == 2)
		{
			switch(pre_channel_position_h)
			{
				case 0:
					span_contain_list[0].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 27;
					span_contain_list[0].innerHTML = ">";
					},500);
					break;
				case 1:
					span_contain_list[1].innerHTML = other[1];
					setTimeout(function(){
					factory.presetFactoryChannel = 28;
					span_contain_list[1].innerHTML = ">";
					},500);
					break;
                case 2:
                    span_contain_list[2].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 29;
                        span_contain_list[2].innerHTML = ">";
                    },500);
                    break;
                case 3:
                    span_contain_list[3].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 30;
                        span_contain_list[3].innerHTML = ">";
                    },500);
                    break;
				case 4:
                    span_contain_list[4].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 31;
                        span_contain_list[4].innerHTML = ">";
                    },500);
					break;
				case 5:
                    span_contain_list[5].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 32;
                        span_contain_list[5].innerHTML = ">";
                    },500);
					break;
				case 6:
                    span_contain_list[6].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 33;
                        span_contain_list[6].innerHTML = ">";
                    },500);
					break;
				case 7:
                    span_contain_list[7].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 34;
                        span_contain_list[7].innerHTML = ">";
                    },500);
					break;
				case 8:
                    span_contain_list[8].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 35;
                        span_contain_list[8].innerHTML = ">";
                    },500);
					break;
				case 9:
                    span_contain_list[9].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 36;
                        span_contain_list[9].innerHTML = ">";
                    },500);
					break;
				case 10:
                    span_contain_list[10].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 37;
                        span_contain_list[10].innerHTML = ">";
                    },500);
					break;
				case 11:
                    span_contain_list[11].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 39;
                        span_contain_list[11].innerHTML = ">";
                    },500);
					break;
				case 12:
                    span_contain_list[12].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 40;
                        span_contain_list[12].innerHTML = ">";
                    },500);
					break;
				case 13:
                    span_contain_list[13].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 41;
                        span_contain_list[13].innerHTML = ">";
                    },500);
					break;
				default:
        ...
        else if(preset_menu_page == 3)
        {
            switch(pre_channel_position_h)
            {
                case 0:
                    span_contain_list[0].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 42;
                        span_contain_list[0].innerHTML = ">";
                    },500);
                    break;
				case 1:
                    span_contain_list[1].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 43;
                        span_contain_list[1].innerHTML = ">";
                    },500);
                    break;
				case 2:
                    span_contain_list[2].innerHTML = other[1];
                    setTimeout(function(){
                        factory.presetFactoryChannel = 46;
                        span_contain_list[2].innerHTML = ">";
                    },500);
                    break;
                default:
...
function toUp()
{
	...
	else if(form_flag == 8)
	{
        if (pre_channel_position_h == 0) {
            if(preset_menu_page == 0){
                preset_menu_page = preset_channel_max_page;
            }
            else {
                preset_menu_page--;
            }
            ...
            div_contain_list[1].style.background = "#FFF";
            div_contain_list[current_page_item_length].style.background = "#FF0";
            pre_channel_position_h = current_page_item_length-1;
        }
		else
		{
			div_contain_list[pre_channel_position_h + 1].style.background = "#FFF";
...
function toDown()
{
	...
	{
        if (pre_channel_position_h == ( current_page_item_length - 1)) {
            if(preset_menu_page<preset_channel_max_page) {
                preset_menu_page++;
            }
            else {
                preset_menu_page = 0;
            ...
            showPresetChannelMenu();
            div_contain_list[current_page_item_length].style.background = "#FFF";
            div_contain_list[1].style.background = "#FF0";
	...
	if(form_flag == 0)
	{
		switch(position_h)
		{
			case 2:
				...
				setTimeout(function(){
					span_contain_list[2].innerHTML = other[2];
					document.location.href = "../initSetup/initSetup.html";
					},3000);
				*/
				top.sendEvent("vod.netflix", 0xf00c);
			...
			case 5:
				...
				setTimeout(function(){
					...
					if(factory.nvmReset()==0)
					{
				        ...
				        top.showFactoryHotkey();
				        span_contain_list[0].innerHTML = off_on[factoryHotkey];
                        span_contain_list[7].innerHTML = power_on_mode[factory.powerOnMode];
						if(factoryHotkey == 0)
						{
							div_contain_list[2].style.background = "#CCC";
						}
...
function doNum(num)
{
	...
	else if(form_flag == 4)
	{
		if(InputNumCount < 3)
		{
			...
			InputID = InputID*10 + num;
			InputNumCount++;
			span_contain_list[0].innerHTML = InputID;
			if(InputNumCount == 3)
			{
...
function showFactory()
{
	...
	{
        span_contain_list[10].innerHTML = factoryInfo.swName+"."+top.configPackVersion;
	}
...
function showOtherMenu()
{
	...
	if (ADD_RESET_ALL_IN_OTHER_MENU == 1)
	{
		span_contain_list[IDX_OTHER_RESET_ALL].innerHTML = other[0];
	}
    ...
    span_contain_list[11].innerHTML = "N/A";
    span_contain_list[12].innerHTML = "N/A";
    span_contain_list[13].innerHTML = "N/A";
...
function showPresetChannelMenu() {
    ...
    preset_channel_max_page = (preset_channel.length%14==0)? parseInt(preset_channel.length/14)-1: parseInt(preset_channel.length/14) ;  //1页14个选项
    current_page_item_length = 14;
    if(preset_menu_page == preset_channel_max_page && (preset_channel.length%14!=0))
    {
        current_page_item_length = preset_channel.length%14; //最后一页选项个数
    }
    ...
    for (var i = 0; i < current_page_item_length; i++) {
        div_contain_list[i + 1].style.background = "#FFF";
    }

    //初始化菜单项
    div_contain_list[0].innerHTML = preset_channel_title;
    for (var i = 1; i <= current_page_item_length; i++) {
        div_contain_list[i].innerHTML = preset_channel[i+ preset_menu_page*14-1];
    }

    for (var j = 1; j <= current_page_item_length; j++) {
        span_contain_list[j - 1].innerHTML = ">";
    }
...
function showIPTVMenu()
{
	...
	span_contain_list[0].innerHTML = "";
    span_contain_list[1].innerHTML = factory.getClientTypeKey();
...
function showMacAddrMenu()
{
	...
	span_contain_list[0].innerHTML = ">";
	span_contain_list[1].innerHTML = 1 == factory.getEsnUartFlag() ? "OK" : "NULL";
...
function doResetAll()
{	
	span_contain_list[IDX_OTHER_RESET_ALL].innerHTML = other[1];
	setTimeout(function(){
		top.sendEvent("vod.netflix", 0xf00c);
		if(factory.nvmResetAll(0)==0)
		{
			span_contain_list[IDX_OTHER_RESET_ALL].innerHTML = other[2];
			top.g_factory_designModeHotkey = 0;//工厂菜单设计规范的
		...
		{
			span_contain_list[IDX_OTHER_RESET_ALL].innerHTML = other[3];
		}
	},500);
}
