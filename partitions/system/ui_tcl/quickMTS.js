...
{
    if (channel.checkhbbtvStatus() == 3)//调hbbtv音轨接口
    {
	...
	if(mtsLength>9)
	{
		...
		else
		{
			...
			for (var i = 0; i < 9; i++)
			{
                ...
                {
                    if (visuals[i] == 3) {
                        $("audiohandicap_picture").style.top = 143 + i * presetFocusWidth + "px";
                        $("audiohandicap_picture").style.display = "block";
                    }
                    else {
                        $("audiohandicap_picture").style.display = "none";
                    }
                }
			}
		}
