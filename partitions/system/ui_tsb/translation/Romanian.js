...
var all_country 	= ["Australia","Austria","Belgia","Bulgaria","Croaţia","Republica Cehă","Danemarca","Finlanda","Franţa","Germania",
						...
						"Lituania","","","","","","Bosnia Hercegovina","Cyprus","Kosovo","Macedonia",
						"Malta","Muntenegru","Others"];
...
var sysOptions		= ["Manual electronic","Limbă meniu","Cronometru","Blocare","Setări intrare",
						...
						"Setări avansate","Reset. magaz.","Indicator LED","Pornire instant","Auto shop mode","Area","Mod demonstrativ"];
...
var picOptions		= ["Preset imag.",
						...
						"Setări avansate","Resetare imagine"];
...
var smartTVOptions		= ["Portal Smart TV","HbbTV","Partajare şi vizualizare","Afişaj WiFi","Politică Smart TV",
    "Standby reţea","Resetare smart TV"];
...
var eStickerTipWords = ["Capacitatea de stocare este sub 500M, doriți să ștergeți clipurile din modul Demo pentru a obține mai mult spațiu?"];
