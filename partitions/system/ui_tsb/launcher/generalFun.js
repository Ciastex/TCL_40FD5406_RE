...
function jumpToApp()
{
    ...
    else if (appName == "Chili-eu")
    {
        tcl.channel.requestInputSource(10);
        top.g_setting.setProperty("app.ui.currentApp","tbrowser.common");
        top.g_ulits.openApplication("tbrowser.common","https://vestel.chili.tv");
    }
    ...
    else if (appName == "Claro Video")
    {
        tcl.channel.requestInputSource(10);
        top.g_setting.setProperty("app.ui.currentApp","tbrowser.common");
        top.g_ulits.openApplication("tbrowser.common","http://1067564395.a.fxmconnect.com/?app=hispantv");
    }
    else if (appName == "HispanTV")
    {
        tcl.channel.requestInputSource(10);
        top.g_setting.setProperty("app.ui.currentApp","tbrowser.common");
        top.g_ulits.openApplication("tbrowser.common","http://1067564395.a.fxmconnect.com/?app=hispantv");
    }
    else if (appName == "Clima")
    {
        tcl.channel.requestInputSource(10);
        top.g_setting.setProperty("app.ui.currentApp","tbrowser.common");
        top.g_ulits.openApplication("tbrowser.common","http://1067564395.a.fxmconnect.com/?app=clima");
    }
...
function updateZeasn() {
    ...
    for (var i = 0; i < fav.length; i++) {
        ...
        app.innerHTML = '<img src="images/APP_bg.png?md5=606d3cca9424a58a1ea63f54eb8523d5" class="app_background"/><img src="' + fav[i].icon + '" class="app_foreground"/><img src="images/zhezhao.png" class="app_zhezhao"><span class="elem_block_title">' + fav[i].name + '</span>';
