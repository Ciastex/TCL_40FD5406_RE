...
function timerToRight(){
	console.log("clear timerToRight!");
	if(timerForRight)
	{
		clearTimeout(timerForRight);
		timerForRight = 0;
	}
	timerForRight = setTimeout(function ()
	{
		toRight();
	}, 100);
}
		...
		switch(parseInt(tempValue[0]))
		{
			case 0:
			{
				if(parseInt(tempValue[1])==1 || setting.networkStatus())
				{
                    ...
                    {
                        document.location.href="initRegister.html";
					}
					else
					{
